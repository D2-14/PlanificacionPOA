...
{
    public partial class ExportarExcelPOA : System.Web.UI.Page
    {
        ...
        protected void GdrConfiguracion_NeedDataSource(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
        {
            DatosTarea Dt;           
            Dt = (DatosTarea)Session["info50"];           
            procesos.LlenarRadGrid(GdrConfiguracion, "EXEC Sp_obtener_data_Actividad_SubregionalExcel " + Dt.Id_PoAnual.ToString()+","+ Dt.Id_SubRegion.ToString() + ";");
        }
    }
}