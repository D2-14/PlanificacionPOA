<%@ Page Title="" Language="C#" MasterPageFile="~/MarcoTrabajo/Site.Master" AutoEventWireup="true" CodeBehind="Tareas_Regional.aspx.cs" Inherits="PlanificacionPOA.Paginas.Tareas_Regional" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <div class="page-header card">
        <div class="card-block">
             <h5 class="m-b-10">Tareas Asignadas al Regional</h5>
                   <p class="text-muted m-b-10">En este Apartado estan las tareas asignadas al director Regional</p>
                      ...
                      <ContentTemplate>
                          <telerik:radwindowmanager ID="RadWindowManager1" runat="server" RenderMode="Classic" EnableShadow="true" Skin="Office2007"></telerik:radwindowmanager>                        
                               <telerik:RadGrid runat="server" ID="GridTareaP" AutoGenerateColumns="False" Width="100%" AllowSorting ="false" AllowFilteringByColumn="false" AllowPaging="True" 
                                   ...
                                   DataKeyNames="Id_PoAnual,FechaDeAsignacion,FechaDeEntrega,EstadoDeAsignacion,Id_Region,Id_Subregion,IdMensaje,Instrucciones,Asignado,TipoAsignacion,NoReprogramacion" NoMasterRecordsText="Sin Información">
