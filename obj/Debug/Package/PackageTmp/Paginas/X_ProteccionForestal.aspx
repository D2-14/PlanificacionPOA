<%@ Page Title="" Language="C#" MasterPageFile="~/MarcoTrabajo/Site.Master" AutoEventWireup="true" CodeBehind="X_ProteccionForestal.aspx.cs" Inherits="PlanificacionPOA.Paginas.X_ProteccionForestal" %>
                         ...
                         <table runat="server" id="Encabezado" style="margin:auto;border-collapse:separate;border-spacing: 2px;"> 
                          ...
                          <div class="panel panel-success">
                           <div class="panel-heading" style="text-align:center;"></div>
                              ...
                              <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="I1" runat="server" visible="false">
                                  <tr>
                                       <td><asp:Label ID="Label14" runat="server" Font-Bold="true" Text="Tipo de Bosque" Font-Size="10" ForeColor="#006699"/></td>
                                       <td style="width:20px"></td>
                                       <td><asp:Label ID="Label15" runat="server" Font-Bold="true" Text="Tipo de Incendio" Font-Size="10" ForeColor="#006699"/></td>
                                  </tr>
                                  <tr>
                                     <td><telerik:RadComboBox ID="CboBosque" AutoPostBack="true" runat="server" Filter="Contains" EmptyMessage="Seleccione Tipo de Bosque" Width="250px"></telerik:RadComboBox></td>
                                       <td style="width:20px"></td>
                                     <td><telerik:RadComboBox ID="CboIncendio" AutoPostBack="true" runat="server" Filter="Contains" EmptyMessage="Seleccione Tipo de Incendio" Width="250px"></telerik:RadComboBox></td>  
                                   </tr>
                                  <tr><td colspan="3"><asp:Label ID="Label17" runat="server" Font-Bold="true" Text="Tipo de Administración" Font-Size="10" ForeColor="#006699"/></td></tr>
                                  <tr><td colspan="3"><telerik:RadComboBox ID="CboAdministracion" AutoPostBack="true" runat="server" Filter="Contains" EmptyMessage="Seleccione Tipo de Administración" Width="500px"></telerik:RadComboBox></td></tr>
                              </table>
                                <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="I2" runat="server" visible="false">
                                    <tr>
                                       <td><asp:Label ID="Label19" runat="server" Font-Bold="true" Text="Tipo de Escenario" Font-Size="10" ForeColor="#006699"/></td>
                                       <td style="width:20px"></td>
                                       <td><asp:Label ID="Label20" runat="server" Font-Bold="true" Text="Héctarias" Font-Size="10" ForeColor="#006699"/></td>
                                  </tr>
                                    <tr>
                                        <td><telerik:RadComboBox ID="CboEscenario" AutoPostBack="true" runat="server" Filter="Contains" EmptyMessage="Seleccione Tipo de Escenario" Width="250px"></telerik:RadComboBox></td>
                                        <td style="width:20px"></td>
                                         <td id="op1" runat="server" visible="false"><telerik:RadNumericTextBox ID="txthectaria1" runat="server" Width="250px" style="text-align:right;" MinValue="0" 
                                              onkeydown="return (event.keyCode!=13);" MaxLength="3" NumberFormat-DecimalDigits="2" 
                                              NumberFormat-DecimalSeparator="."></telerik:RadNumericTextBox></td>
                                        <td id="op2" runat="server" visible="false" style="text-align:center;"><asp:TextBox ID="txtRespuesta" Font-Names="Arial" Font-Size="10" runat="server" Width="250px" ForeColor="#006699" Text="No Aplica" ReadOnly="true"></asp:TextBox></td>
                                    </tr>
                                   <tr>
                                       <td><asp:Label ID="Label22" runat="server" Font-Bold="true" Text="Agente Causal" Font-Size="10" ForeColor="#006699"/></td>
                                       <td style="width:20px"></td>
                                       <td><asp:Label ID="Label23" runat="server" Font-Bold="true" Text="Número de Muestra(Correlativo Regional)" Font-Size="10" ForeColor="#006699"/></td>
                                  </tr>
                                    <tr>
                                        <td><asp:TextBox ID="txtAgenteCausal1" Font-Names="Arial" Font-Size="10" runat="server" Width="250px" ForeColor="#006699"></asp:TextBox></td>
                                         <td style="width:20px"></td>
                                        <td><asp:TextBox ID="NoMuestraRegionC" Font-Names="Arial" Font-Size="10" runat="server" Width="250px" ForeColor="#006699"></asp:TextBox></td>
                                    </tr>
                                </table> 
                                <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="I3" runat="server" visible="false">
                                    <tr>
                                       <td><asp:Label ID="Label24" runat="server" Font-Bold="true" Text="Tipo Área Bajo Manejo" Font-Size="10" ForeColor="#006699"/></td>
                                       <td style="width:20px"></td>
                                       <td><asp:Label ID="lbltituloAreab" runat="server" Font-Bold="true" Text="AreaBajo" Font-Size="10" ForeColor="#006699"/></td>
                                  </tr>
                                    <tr>
                                        <td><telerik:RadComboBox ID="CboTipoABM" AutoPostBack="true" runat="server" Filter="Contains" EmptyMessage="Seleccione Tipo de Area Bajo Manejo" Width="250px"></telerik:RadComboBox></td>
                                        <td style="width:20px"></td>
                                        <td><telerik:RadComboBox ID="CboAreaBM" AutoPostBack="true" runat="server" Filter="Contains" EmptyMessage="Seleccione Area Bajo Manejo" Width="250px"></telerik:RadComboBox></td>
                                    </tr>
                                    <tr><td colspan="3"><asp:Label ID="Label27" runat="server" Font-Bold="true" Text="Fase de Proyecto" Font-Size="10" ForeColor="#006699"/></td></tr>
                                    <tr><td colspan="3"><telerik:RadComboBox ID="CboFase" AutoPostBack="true" runat="server" Filter="Contains" EmptyMessage="Seleccione Fase de Proyecto" Width="500px"></telerik:RadComboBox></td></tr>                                     
                                </table> 
                              <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="I4" runat="server" visible="false">
                                  <tr>
                                    <td><asp:Label ID="Label28" runat="server" Font-Bold="true" Text="Coordenada en X" Font-Size="10" ForeColor="#006699"/></td>
                                    <td style="width:20px"></td>
                                    <td><asp:Label ID="Label31" runat="server" Font-Bold="true" Text="Coordenada en Y" Font-Size="10" ForeColor="#006699"/></td>
                                  </tr>  
                                  <tr>
                                       <td><telerik:RadNumericTextBox ID="txtCoordenadax" runat="server" Width="250px" style="text-align:right;" MinValue="0" 
                                              onkeydown="return (event.keyCode!=13);" MaxLength="6" NumberFormat-DecimalDigits="2" 
                                              NumberFormat-DecimalSeparator="."></telerik:RadNumericTextBox></td>
                                       <td style="width:20px"></td>
                                       <td><telerik:RadNumericTextBox ID="txtCoordenaday" runat="server" Width="250px" style="text-align:right;" MinValue="0" 
                                              onkeydown="return (event.keyCode!=13);" MaxLength="7" NumberFormat-DecimalDigits="0" 
                                              NumberFormat-DecimalSeparator="."></telerik:RadNumericTextBox></td>
                                  </tr>
                                    </table> 
                                <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="I6" runat="server" visible="false">
                                   <tr>
                                    <td><asp:Label ID="Label32" runat="server" Font-Bold="true" Text="Nombre de Contacto" Font-Size="10" ForeColor="#006699"/></td>
                                    <td style="width:20px"></td>
                                    <td><asp:Label ID="Label33" runat="server" Font-Bold="true" Text="Número de Teléfono" Font-Size="10" ForeColor="#006699"/></td>
                                  </tr>
                                  <tr>
                                      <td><asp:TextBox ID="txtContacto" Font-Names="Arial" Font-Size="10" runat="server" Width="250px" ForeColor="#006699"></asp:TextBox></td>
                                      <td style="width:20px"></td>
                                       <td><telerik:RadNumericTextBox ID="txttelefono" runat="server" Width="250px" style="text-align:right;" MinValue="0" 
                                              onkeydown="return (event.keyCode!=13);" MaxLength="8" NumberFormat-DecimalDigits="0"
                                              NumberFormat-DecimalSeparator="."></telerik:RadNumericTextBox></td>
                                  </tr>

                                      </table>
                               <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="I7" runat="server" visible="false">
                                  <tr><td colspan="3"><asp:Label ID="Label37" runat="server" Font-Bold="true" Text="Equipo de Protección" Font-Size="10" ForeColor="#006699"/></td></tr>
                                  <tr><td colspan="3"><telerik:RadComboBox ID="CboEquipoP" AutoPostBack="true" runat="server" Filter="Contains" EmptyMessage="Seleccione Equipo Protección" Width="500px"></telerik:RadComboBox></td></tr>
                            </table>
                                  

                               <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="I5" runat="server" visible="false">
                                    <tr>
                                        <td><asp:Label ID="Label38" runat="server" Font-Bold="true" Text="Número de Expediente" Font-Size="10" ForeColor="#006699"/></td>
                                        <td style="width:20px"></td>
                                        <td><asp:Label ID="Label39" runat="server" Font-Bold="true" Text="Agente Causal (Nombre Cientifico)" Font-Size="10" ForeColor="#006699"/></td>
                                    </tr>
                                   <tr>
                                       <td><asp:TextBox ID="txtNumeroExpediente" Font-Names="Arial" Font-Size="10" runat="server" Width="250px" ForeColor="#006699"></asp:TextBox></td>
                                      <td style="width:20px"></td>  
                                       <td><asp:TextBox ID="txtAgenteCausal2" Font-Names="Arial" Font-Size="10" runat="server" Width="250px" ForeColor="#006699"></asp:TextBox></td>
                                   </tr>
                                    <tr>
                                        <td><asp:Label ID="Label42" runat="server" Font-Bold="true" Text="Nombre de Títular" Font-Size="10" ForeColor="#006699"/></td>
                                        <td style="width:20px"></td>
                                        <td><asp:Label ID="LbltituloHectaria" runat="server" Font-Bold="true" Text="Hectarías" Font-Size="10" ForeColor="#006699"/></td>
                                    </tr>
                                   <tr>
                                       <td><asp:TextBox ID="txtnombreTitular" Font-Names="Arial" Font-Size="10" runat="server" Width="250px" ForeColor="#006699"></asp:TextBox></td>
                                        <td style="width:20px"></td>
                                        <td><telerik:RadNumericTextBox ID="txthectaria2" runat="server" Width="250px" style="text-align:right;" MinValue="0" 
                                              onkeydown="return (event.keyCode!=13);" MaxLength="3" NumberFormat-DecimalDigits="2" 
                                              NumberFormat-DecimalSeparator="."></telerik:RadNumericTextBox></td>
                                   </tr>
                               </table> 
                            ...
                            <telerik:RadGrid runat="server" ID="GrdIngresoEncabezado" AutoGenerateColumns="False" Width="100%" AllowSorting ="false" AllowFilteringByColumn="false" AllowPaging="True" 
                                   ...
                                   <RowIndicatorColumn Visible="False"></RowIndicatorColumn>
                                    <Columns>
                                   <telerik:GridButtonColumn Text="Ingreso Comunidad Linguistica" CommandName="Select1" Visible="false" HeaderText="Ingreso<br/>Comunidad Linguistica" UniqueName="BotonD" Display="false"   
                                          ...
                                          <telerik:GridButtonColumn Text="Ingreso Grupo Etario" CommandName="Select2" Visible="false" HeaderText="Ingreso<br/>Grupo Etario" UniqueName="Botonc" Display="false"   
                                              ButtonType="ImageButton" ImageUrl="../Iconos/Agregar.png" ButtonCssClass="imageButtonClass">
                                          <HeaderStyle Font-Size="8" HorizontalAlign="Center" Font-Names="Arial"/>
                                               <ItemStyle HorizontalAlign="Center"/>
                                         </telerik:GridButtonColumn>        
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">                                                  
                            <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="x1" runat="server" visible="false"> 
                                ...
                                <tr>
                                    <td><asp:Label ID="Label35" runat="server" Font-Bold="true" Text="Agente Causal(Nombre Cientifico):" Font-Size="10" Width="200px" ForeColor="#006600"/></td>
                                    <td><asp:Label ID="LblAgente1" runat="server" Font-Bold="true" Font-Size="10" Width="200px" ForeColor="#000066"/></td>                                                                                                                                                                       
                                </tr>
                                <tr>
                                  <td><asp:Label ID="Label36" runat="server" Font-Bold="true" Text="Nombre del Titular" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="lblTitular" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr> 
                                 <tr>
                                  <td><asp:Label ID="LbltituloH" runat="server" Font-Bold="true" Text="Hectarias" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="lblHectaria1" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>  
                            </table> 
                             <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="x2" runat="server" visible="false">                               
                                <tr>
                                    <td><asp:Label ID="Label25" runat="server" Font-Bold="true" Text="Coornadas en X:" Font-Size="10" Width="200px" ForeColor="#006600"/></td>
                                    <td><asp:Label ID="lblCoordenadax" runat="server" Font-Bold="true" Font-Size="10" Width="200px" ForeColor="#000066"/></td>
                                </tr>
                                <tr>
                                  <td><asp:Label ID="Label41" runat="server" Font-Bold="true" Text="Coornadas en Y:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="LbCoordenaday" runat="server" Font-Bold="true" Width="200px" Text="xxx" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                                <tr>
                                  <td><asp:Label ID="Label40" runat="server" Font-Bold="true" Text="Nombre del Contacto:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="lblNombreContacto" runat="server" Font-Bold="true" Width="200px" Text="xxx" Font-Size="10" ForeColor="#000066"/></td>
                                </tr> 
                                 <tr>
                                  <td><asp:Label ID="Label16" runat="server" Font-Bold="true" Text="Número de Teléfono:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="lblNumeroTelefono" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                                  <tr>
                                  <td><asp:Label ID="Label43" runat="server" Font-Bold="true" Text="Equipo de Protección:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="LblequipoProteccion" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>   
                            </table>
                            <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="x3" runat="server" visible="false">
                                 <tr>
                                  <td><asp:Label ID="Label44" runat="server" Font-Bold="true" Text="Tipo de Área Bajo Manejo:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="LbltipoBM" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr> 
                                 <tr>
                                  <td><asp:Label ID="Lbltitulotabm" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="lblareabm" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                                <tr>
                                  <td><asp:Label ID="Label45" runat="server" Font-Bold="true" Text="Fase de Proyecto:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="lblFaseproyecto" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr> 
                             </table>
                            <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="x4" runat="server" visible="false">
                                <tr>
                                  <td><asp:Label ID="Label46" runat="server" Font-Bold="true" Text="Tipo de Escenario:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="lblescenario" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr> 
                                 <tr>
                                  <td><asp:Label ID="Label47" runat="server" Font-Bold="true" Text="Hectarias" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="lblHectaria2" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                                <tr>
                                    <td><asp:Label ID="Label48" runat="server" Font-Bold="true" Text="Agente Causal(Nombre Cientifico):" Font-Size="10" Width="200px" ForeColor="#006600"/></td>
                                    <td><asp:Label ID="LblAgente2" runat="server" Font-Bold="true" Font-Size="10" Width="200px" ForeColor="#000066"/></td>                                                                                                                                                                       
                                </tr>
                                 <tr>
                                    <td><asp:Label ID="Label49" runat="server" Font-Bold="true" Text="Número de Muestra(Correlativo Regional):" Font-Size="10" Width="200px" ForeColor="#006600"/></td>
                                    <td><asp:Label ID="lblNomuestra" runat="server" Font-Bold="true" Font-Size="10" Width="200px" ForeColor="#000066"/></td>                                                                                                                                                                       
                                </tr>
                            </table>
                             <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="x5" runat="server" visible="false">
                                 <tr>
                                  <td><asp:Label ID="Label50" runat="server" Font-Bold="true" Text="Tipo de Bosque:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="lblBosque" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr> 
                                 <tr>
                                  <td><asp:Label ID="Label56" runat="server" Font-Bold="true" Text="Tipo de Incendio:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="lblincendio" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                                  <tr>
                                  <td><asp:Label ID="Label57" runat="server" Font-Bold="true" Text="Tipo de Administración:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="lbladministracion" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                             </table> 
