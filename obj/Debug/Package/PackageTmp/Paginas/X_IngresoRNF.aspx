<%@ Page Title="" Language="C#" MasterPageFile="~/MarcoTrabajo/Site.Master" AutoEventWireup="true" CodeBehind="X_IngresoRNF.aspx.cs" Inherits="PlanificacionPOA.Paginas.X_IngresoRNF" %>
                          ...
                          <div class="panel panel-success">
                           <div class="panel-heading" style="text-align:center;"></div>
                               ...
                               <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="t3" runat="server" visible="false">
                                    <tr>
                                        <td><asp:Label ID="LblTitulo1" runat="server" Font-Bold="true" Text="Tipo de Denegación" Font-Size="10" ForeColor="#006699"/></td>
                                        <td style="width:20px"></td>
                                        <td><asp:Label ID="Label14" runat="server" Font-Bold="true" Text="Número de Expediente" Font-Size="10" ForeColor="#006699"/></td>
                                     </tr> 
                                    <tr>
                                        <td><telerik:RadComboBox ID="CboDenegacion" runat="server" EmptyMessage="Seleccione Tipo de Denegación" Width="250px"></telerik:RadComboBox></td>
                                        <td style="width:20px"></td>
                                        <td><asp:TextBox ID="txtNoExpediente" Font-Names="Arial" Font-Size="9" runat="server" Width="250px" ForeColor="#006699"></asp:TextBox></td>
                                    </tr> 
                                    <tr><td colspan="3"><asp:Label ID="Label15" runat="server" Font-Bold="true" Text="Categoría" Font-Size="10" ForeColor="#006699"/></td></tr> 
                                    <tr><td colspan="3"><asp:TextBox ID="txtCategoria" Font-Names="Arial" Font-Size="9" runat="server" Width="500px" ForeColor="#006699"></asp:TextBox></td></tr>     
                                    <tr><td colspan="3"><asp:Label ID="Label19" runat="server" Font-Bold="true" Text="Subcategoría" Font-Size="10" ForeColor="#006699"/></td></tr> 
                                    <tr><td colspan="3"><asp:TextBox ID="txtSubcategoria" Font-Names="Arial" Font-Size="9" runat="server" Width="500px" ForeColor="#006699"></asp:TextBox></td></tr> 
                                    <tr><td colspan="3"><asp:Label ID="Label20" runat="server" Font-Bold="true" Text="Especificaciones" Font-Size="10" ForeColor="#006699"/></td></tr> 
                                    <tr><td colspan="3"><asp:TextBox ID="txtEspecificaciones" Font-Names="Arial" Font-Size="9" runat="server" Width="500px" ForeColor="#006699"></asp:TextBox></td></tr> 
                                 </table>                              
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">                                                  
                            <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="x1" runat="server" visible="false"> 
                                <tr>
                                    <td><asp:Label ID="Label22" runat="server" Font-Bold="true" Text="Fecha:" Font-Size="10" Width="200px" ForeColor="#006600"/></td>
                                    <td><asp:Label ID="lblFechaCorresponde" runat="server" Font-Bold="true" Font-Size="10" Width="200px" ForeColor="#000066"/></td>
                                </tr>
                                  <tr>
                                ...
                                <tr><td><asp:Label ID="Label35" runat="server" Font-Bold="true" Text="Categoria:" Font-Size="10" Width="200px" ForeColor="#006600"/></td>
                                    <td><asp:Label ID="lblCategoria" runat="server" Font-Bold="true" Font-Size="10" Width="200px" ForeColor="#000066"/></td>                                                                                                                                                                       
                                </tr>
                                <tr><td><asp:Label ID="Label23" runat="server" Font-Bold="true" Text="Subcategoría:" Font-Size="10" Width="200px" ForeColor="#006600"/></td>
                                    <td><asp:Label ID="lblSubcategoria" runat="server" Font-Bold="true" Font-Size="10" Width="200px" ForeColor="#000066"/></td>                                                                                                                                                                       
                                </tr>
                                <tr><td><asp:Label ID="Label24" runat="server" Font-Bold="true" Text="Especificaciones:" Font-Size="10" Width="200px" ForeColor="#006600"/></td>
                                    <td><asp:Label ID="lblEspecificaciones" runat="server" Font-Bold="true" Font-Size="10" Width="200px" ForeColor="#000066"/></td>                                                                                                                                                                       
                                </tr>
                                <tr>
                                  <td><asp:Label ID="Label36" runat="server" Font-Bold="true" Text="Tipo de Denegación" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="lblDenegacion" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>                                                                  
                            </table> 
                             <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="x2" runat="server" visible="false">                               
                               <tr>
                                  <td><asp:Label ID="Label40" runat="server" Font-Bold="true" Text="Fecha:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="lblFechaCorresponde1" runat="server" Font-Bold="true" Width="200px" Text="xxx" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                                 <tr>
                                    <td><asp:Label ID="Label26" runat="server" Font-Bold="true" Text="Número de Registro:" Font-Size="10" Width="200px" ForeColor="#006600"/></td>
                                    <td><asp:Label ID="lblNoRegistro" runat="server" Font-Bold="true" Font-Size="10" Width="200px" ForeColor="#000066"/></td>
                                </tr>
                                 <tr>
                                    <td><asp:Label ID="Label25" runat="server" Font-Bold="true" Text="Número de Expediente:" Font-Size="10" Width="200px" ForeColor="#006600"/></td>
                                    <td><asp:Label ID="lblNoExpediente1" runat="server" Font-Bold="true" Font-Size="10" Width="200px" ForeColor="#000066"/></td>
                                </tr>
                                <tr>
                                  <td><asp:Label ID="Label41" runat="server" Font-Bold="true" Text="Tipo de Registro:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="lblTipoRegistro" runat="server" Font-Bold="true" Width="200px" Text="xxx" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                                  <tr>
                                  <td><asp:Label ID="Label16" runat="server" Font-Bold="true" Text="Estado del RNF:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="lblEstadoRNF" runat="server" Font-Bold="true" Width="200px" Text="xxx" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>   
                            </table>
