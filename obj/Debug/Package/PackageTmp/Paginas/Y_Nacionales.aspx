<%@ Page Title="" Language="C#" MasterPageFile="~/MarcoTrabajo/Site.Master" AutoEventWireup="true" CodeBehind="Y_Nacionales.aspx.cs" Inherits="PlanificacionPOA.Paginas.Y_Nacionales" %>
                 ...
                 <table style="border-collapse:separate;border-spacing:3px;">
                     <tr>
                         <td>
                              <table style="border-collapse:separate;border-spacing:3px;">
                                  <tr>
                                      <td><asp:Label ID="Label1" runat="server" Font-Bold="true" Text="INGRESO DE METAS " Font-Size="13" ForeColor="#006699"/></td>
                                      <td><asp:Label ID="lblPoa" runat="server" Font-Bold="true" Font-Size="13" ForeColor="#009933"/></td>
                                  </tr>
                              </table> 
                         </td>                        
                     </tr>
                    <tr><td colspan="2"><asp:Label ID="lblObjeto" runat="server" Font-Bold="true" Font-Size="11" ForeColor="#009933"/></td></tr>
                     <tr><td colspan="2"><asp:Label ID="lblregion" runat="server" Font-Bold="true" Font-Size="11" ForeColor="#006699"/></td></tr> 
                    <tr><td colspan="2"><asp:Label ID="lbsubregion" runat="server" Font-Bold="true" Font-Size="11" ForeColor="#006699"/></td></tr>                                   
                  <tr>
                      <td>
                        <Table style="border-collapse:separate;border-spacing:3px;">
                         <tr>
                      ...
                      <Table style="border-collapse:separate;border-spacing:5px;font-family:Arial;font-size:13px;font-weight:bold;" id="subcomp" runat="server">
                         <tr>
                             ...
                             <Table style="border-collapse:separate;border-spacing:5px;font-family:Arial;font-size:13px;font-weight:bold;">
                                ...
                                <td><asp:LinkButton ID="btnFinalizarIngreso" Visible="false" runat="server" CssClass="btn btn-warning btn-sm" ToolTip="Finalizar ingreso" Text="Guardar">
                     ...
                     <table runat="server" id="Encabezado" style="margin:auto;border-collapse:separate;border-spacing: 2px;"> 
                               ...
                               <table style="border-collapse:separate;border-spacing:10px;font-family:Arial;font-size:13px;font-weight:bold;">
                                <tr>
                                   <td><asp:LinkButton ID="Guardar" runat="server" CssClass="btn btn-primary btn-sm" ToolTip="Guardar Información" Text="Guardar">
                                    ...
                                    <td><asp:LinkButton ID="CancelarIngreso" runat="server" CssClass="btn btn-danger btn-sm" ToolTip="Limpiar Campos de Información" Text="Guardar">
                                    <span class="glyphicon glyphicon-remove"></span>&nbsp;Limpiar Campos</asp:LinkButton></td>                                  
                                </tr>
                            </table><br />
                               <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;">
                                   <tr id="trum1" runat="server">
                                    ...
                                    <td><telerik:RadNumericTextBox ID="txtum1" runat="server" Width="120px" style="text-align:right;" MinValue="0" 
                                              onkeydown="return (event.keyCode!=13);" MaxLength="15" NumberFormat-DecimalDigits="2" 
                      ...
                      <telerik:RadGrid runat="server" ID="GrdIngresoEncabezado" AutoGenerateColumns="False" Width="100%" AllowSorting ="false" AllowFilteringByColumn="false" AllowPaging="True" 
                                   ...
                                   <RowIndicatorColumn Visible="False"></RowIndicatorColumn>
                                    <Columns>
                                           <telerik:GridButtonColumn Text="Eliminar producto/Subproducto/Actividad" CommandName="Delete" UniqueName="Botonx" HeaderText="Eliminar" ButtonType="ImageButton" 
                ...
                <ContentTemplate>
                    ...
                    <div style="margin-top: 30px; float: left;">
                       ...
                       <div style="width: 250px; float: left;">
                            <asp:Label ID="lblConfirm" Font-Size="14px" runat="server"></asp:Label>
                            <br />
                            <br />
                            </div>
