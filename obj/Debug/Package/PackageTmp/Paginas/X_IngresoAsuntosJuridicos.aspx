<%@ Page Title="" Language="C#" MasterPageFile="~/MarcoTrabajo/Site.Master" AutoEventWireup="true" CodeBehind="X_IngresoAsuntosJuridicos.aspx.cs" Inherits="PlanificacionPOA.Paginas.X_IngresoAsuntosJuridicos" %>
         ...
         <div class="card-block">            
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                 <ContentTemplate>
                     ...
                     <div id="Informacion" runat="server" visible="true">
                               ...
                               <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;">
                                   ...
                                   <tr>
                                     ...
                                     <td><telerik:RadAsyncUpload runat="server" ID="RadDocumentoVerificacion" Culture="es-GT" MaxFileInputsCount="1" 
                                          AllowedFileExtensions=".pdf,.xlsx" Width="250px" ChunkSize="0"></telerik:RadAsyncUpload>                                        
                                     </td>  
                                   </tr>
                                   <tr>
                                        <td></td><td></td>
                     ...
                     <telerik:RadGrid runat="server" ID="GrdIngresoJuridico" AutoGenerateColumns="False" Width="100%" AllowSorting ="false" AllowFilteringByColumn="false" AllowPaging="True" 
