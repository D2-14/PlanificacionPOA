<%@ Page Title="" Language="C#" MasterPageFile="~/MarcoTrabajo/Site.Master" AutoEventWireup="true" CodeBehind="Tareas_Directores_Nacionales.aspx.cs" Inherits="PlanificacionPOA.Paginas.Tareas_Directores_Nacionales" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-header card">
        <div class="card-block">
             <h5 class="m-b-10">Tareas Asignadas al Director Nacional</h5>
                   <p class="text-muted m-b-10">En este Apartado estan las tareas asignadas al Director Nacional</p>
             <ul class="breadcrumb-title b-t-default p-t-10">
                  <li>
                      ...
                      <ContentTemplate>
                          <telerik:radwindowmanager ID="RadWindowManager1" runat="server" RenderMode="Classic" EnableShadow="true" Skin="Office2007"></telerik:radwindowmanager>                        
                               <telerik:RadGrid runat="server" ID="GridTareaP" AutoGenerateColumns="False" Width="100%" AllowSorting ="false" AllowFilteringByColumn="false" AllowPaging="True" 
                                   ...
                                   DataKeyNames="Id_PoAnual,FechaDeAsignacion,FechaDeEntrega,EstadoDeAsignacion,Id_Region,Id_Subregion,IdMensaje,Instrucciones,Asignado,
                                   ...
                                   <RowIndicatorColumn Visible="False"></RowIndicatorColumn>
                                    <Columns>                                                                             
                                      ...
                                      <telerik:GridBoundColumn DataField="Etapa" UniqueName="Etapa" HeaderText="Etapa">
                                        ...
                                        <telerik:GridBoundColumn DataField="Nombre_Region"  UniqueName="Nombre_Region" HeaderText="Coordinación Técnica<br/>Dirección Nacional / Unidad de Apoyo">
                                           <HeaderStyle Width="60px" Font-Size="8" HorizontalAlign="Center" Font-Names="Arial"/>
                                           <ItemStyle HorizontalAlign="Left" Font-Size="8" ForeColor="RoyalBlue" Font-Names="Arial"/>                                           
                                      </telerik:GridBoundColumn>
                                      <telerik:GridButtonColumn Text="Mensaje del Encargado de Planificación" HeaderText="Mensaje" CommandName="Select1" UniqueName="BotonB" ButtonType="ImageButton" ImageUrl="../Iconos/mensaje.png" ButtonCssClass="imageButtonClass">
                    ...
                    <div class="panel panel-success">
                        <div class="panel-heading"><div style="text-align:center;"><span class="glyphicon glyphicon-envelope"></span>&nbsp;&nbsp;<asp:Label ID="Label7" runat="server" Font-Bold="true" Text="Mensaje de tarea a Realizar" Font-Size="10"/></div></div>
