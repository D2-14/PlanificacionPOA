<%@ Page Title="" Language="C#" MasterPageFile="~/MarcoTrabajo/Site.Master" AutoEventWireup="true" CodeBehind="ReprogramacionRegional.aspx.cs" Inherits="PlanificacionPOA.Paginas.ReprogramacionRegional" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
 <div class="page-header card">
        <div class="card-block">
             <h5 class="m-b-10">Tareas de Reprogramación SubRegional</h5>
                   <p class="text-muted m-b-10">En este Apartado se podran hacer las reprogramaciones de las metas ingresadas por el Director SubRegional</p>
