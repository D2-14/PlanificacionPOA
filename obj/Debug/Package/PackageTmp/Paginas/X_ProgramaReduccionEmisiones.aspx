<%@ Page Title="" Language="C#" MasterPageFile="~/MarcoTrabajo/Site.Master" AutoEventWireup="true" CodeBehind="X_ProgramaReduccionEmisiones.aspx.cs" Inherits="PlanificacionPOA.Paginas.X_ProgramaReduccionEmisiones" %>
                         ...
                         <table runat="server" id="Encabezado" style="margin:auto;border-collapse:separate;border-spacing: 2px;"> 
                          ...
                          <div class="panel panel-success">
                           <div class="panel-heading" style="text-align:center;"></div>
                              ...
                              <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;">
                                  <tr>
                                       <td><asp:Label ID="Label40" runat="server" Font-Bold="true" Text="Número de Resolución" Font-Size="10" ForeColor="#006699"/></td>
                                       <td style="width:20px"></td>
                                       <td><asp:Label ID="Label41" runat="server" Font-Bold="true" Text="Fecha de Resolución" Font-Size="10" ForeColor="#006699"/></td>
                                   </tr>
                                  <tr>
                                    <td><asp:TextBox ID="txtNoResolucion" Font-Names="Arial" Font-Size="10" runat="server" Width="250px" ForeColor="#006699"></asp:TextBox></td>
                                    <td style="width:20px"></td>
                                    <td><telerik:RadDatePicker ID="txtFechaResolucion" runat="server" Width="250px" onkeydown="return (event.keyCode!=13);"></telerik:RadDatePicker></td>
                                  </tr>
                                  <tr><td colspan="3"><asp:Label ID="Label42" runat="server" Font-Bold="true" Text="Número de Expediente" Font-Size="10" ForeColor="#006699"/></td></tr>
                                  <tr><td colspan="3"><asp:TextBox ID="txtNoExpediente" Font-Names="Arial" Font-Size="10" runat="server" Width="250px" ForeColor="#006699"></asp:TextBox></td></tr>
                              </table> 
                               <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="Filtro1" visible="false" runat="server">
                                   <tr><td colspan="3"><asp:Label ID="Label43" runat="server" Font-Bold="true" Text="Tipo de Proyecto" Font-Size="10" ForeColor="#006699"/></td></tr>
                                   <tr><td colspan="3"><telerik:RadComboBox ID="CboTipoProyecto" AutoPostBack="true" runat="server" Filter="Contains" EmptyMessage="Seleccione tipo de Proyecto" Width="500px"></telerik:RadComboBox></td></tr>
                               </table>                                                                                                                                                    
                            ...
                            <telerik:RadGrid runat="server" ID="GrdIngresoEncabezado" AutoGenerateColumns="False" Width="100%" AllowSorting ="false" AllowFilteringByColumn="false" AllowPaging="True" 
                                   ...
                                   <RowIndicatorColumn Visible="False"></RowIndicatorColumn>
                                    <Columns>
                                            <telerik:GridButtonColumn Text="Ingreso del detalle de areas por Modalidad" CommandName="Select1" HeaderText="Detalle de<br/>Areas Por Modalidad" UniqueName="BotonD"   
                                              ButtonType="ImageButton" ImageUrl="../Iconos/Agregar.png" ButtonCssClass="imageButtonClass" Visible="false">
                          ...
                          <div id="AreaModalidad" runat="server" visible="false">
                               <table runat="server" id="Table2" style="margin:auto;border-collapse:separate;border-spacing: 2px;"> 
                                    <tr>
                                     <td> 
                                          <div class="panel panel-success">
                                            <div class="panel-heading" style="text-align:center;">
                                            <asp:Label ID="Label26" runat="server" Font-Bold="true" Text="Modalidades" Font-Size="10" ForeColor="#006699"/> </div>
                                                 <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;">                                           
                                            <tr>
                                                <td><asp:Label ID="Label29" runat="server" Font-Bold="true" Text="Modalidad" Font-Size="10" ForeColor="#006699"/></td>                                    
                                                <td style="width:20px"></td>
                                                <td><asp:Label ID="Label17" runat="server" Font-Bold="true" Text="Área (ha)" Font-Size="10" ForeColor="#006699"/></td> 
                                            </tr>
                                            <tr>
                                                <td><telerik:RadComboBox ID="CboModalidad" Skin="MetroTouch" AutoPostBack="true" runat="server" Filter="Contains" EmptyMessage="Seleccione modalidad" Width="250px" DropDownWidth="600" Height="110px"></telerik:RadComboBox></td>                                    
                                                <td style="width:20px"></td>
                                                <td><telerik:RadNumericTextBox ID="txtAreaModalidad" runat="server" Width="250px" style="text-align:right;" MinValue="0" ReadOnly="true"
                                              onkeydown="return (event.keyCode!=13);" MaxLength="10" NumberFormat-DecimalDigits="4" Skin="MetroTouch" 
                                              NumberFormat-DecimalSeparator="."></telerik:RadNumericTextBox></td>
                                            </tr> 
                                        </table>
                                               <table style="margin:auto;border-collapse:separate;border-spacing:10px;text-align:center;">
                                            <tr>
                                                <td ><asp:LinkButton ID="BtnGuardarModalidad" runat="server" CssClass="btn btn-primary btn-sm" ToolTip="Guardar Información" Text="Guardar">
                                                <span class="glyphicon glyphicon-floppy-save"></span>&nbsp;Guardar Información</asp:LinkButton></td>                                      
                               ...
                               <telerik:RadGrid runat="server" ID="GrdModalidadArea" AutoGenerateColumns="False" Width="100%" AllowSorting ="false" AllowFilteringByColumn="false" AllowPaging="True" 
                                   GridLines="Both" Culture="es-GT" Skin="Office2007" ShowStatusBar ="True" ShowGroupPanel="false" ShowFooter="true">
                                   <GroupingSettings CaseSensitive="False" />
                                      <ClientSettings EnableRowHoverStyle="true" AllowColumnsReorder="True">
                                      <Selecting AllowRowSelect="True"></Selecting>                                          
                ...
                <ContentTemplate>
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body"> 
                             <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary">
                                 <tr>
                                    <td><asp:Label ID="Label30" runat="server" Font-Bold="true" Text="Número de Resolución:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>    
                                    <td><asp:Label ID="LNoResolucion" runat="server" Font-Bold="true" Width="200px"  Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                                 <tr>
                                    <td><asp:Label ID="Label15" runat="server" Font-Bold="true" Text="Fecha de Resolución:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>    
                                    <td><asp:Label ID="LFechaResolucion" runat="server" Font-Bold="true" Width="200px"  Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                                 <tr>
                                    <td><asp:Label ID="Label14" runat="server" Font-Bold="true" Text="Número de Expediente:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>    
                                    <td><asp:Label ID="LNoExpediente" runat="server" Font-Bold="true" Width="200px"  Font-Size="10" ForeColor="#000066"/></td>
                                </tr>                                  
                             </table> 
                            <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" visible="false" id="R1" runat="server">
                                <tr>
                                    <td><asp:Label ID="Label16" runat="server" Font-Bold="true" Text="Tipo de Proyecto:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>    
                                    <td><asp:Label ID="LTipoProyecto" runat="server" Font-Bold="true" Width="200px"  Font-Size="10" ForeColor="#000066"/></td>
                                </tr>  
                            </table> 
