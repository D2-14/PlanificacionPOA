<%@ Page Title="" Language="C#" MasterPageFile="~/MarcoTrabajo/Site.Master" AutoEventWireup="true" CodeBehind="SeguimientoPOA.aspx.cs" Inherits="PlanificacionPOA.Paginas.SeguimientoPOA" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %> <%--Para usar telerik (Grid, combo, etc)--%>
 ...
 <ContentTemplate>
     ...
     <div class="page-header card">
        <div class="card-block">
             <h5 class="m-b-10">Mantenimiento - Seguimiento POA</h5>

            <br /><br />

           <asp:Button runat="server" CssClass="form-control" ID="btnRegresar" Text="< Regresar" />

            <br /><br />

             <telerik:RadTabStrip runat="server" ID="ControladorTAb" MultiPageID="Paginas" SelectedIndex="0" Skin="Silk" Culture="es-GT">
                     <Tabs>
                           <telerik:RadTab TabIndex="0" Text="Reportes Nacionales" Width="400px" Font-Size="13px"></telerik:RadTab>
                          <telerik:RadTab TabIndex="1" Text="Reportes Regiones" Width="400px" Font-Size="13px"></telerik:RadTab>            
                     </Tabs>
                     </telerik:RadTabStrip> 
             <telerik:RadMultiPage ID="Paginas" runat="server" SelectedIndex="0">
                        ...
                        <telerik:RadPageView ID="Opcion1" runat="server" Height="100%"  Selected="true"><br/>
                           <div id="Nacionales" runat="server">                                 
                           ...
                           <br/>
                            ...
                            <div id="Tareas" runat="server" visible="false">
                                 <telerik:radwindowmanager ID="RadWindowManager2" runat="server" RenderMode="Classic" EnableShadow="true" Skin="Office2007"></telerik:radwindowmanager>                        
                                <telerik:RadGrid runat="server" ID="GridTareaP" AutoGenerateColumns="False" Width="100%" AllowSorting ="false" AllowFilteringByColumn="false" AllowPaging="True" 
                                   ...
                                   DataKeyNames="Id_PoAnual,IdMensaje,Id_Region,Id_Subregion,POA,Etapa,FechaDeAsignacion,Fecha_Final,EstadoDeAsignacion,
                                                  Nombre_Region,Subregion,Instrucciones,Id_Mes,mes" NoMasterRecordsText="Sin Información">
                                   <RowIndicatorColumn Visible="False"></RowIndicatorColumn>
                                   <Columns>  
                                     <telerik:GridButtonColumn Text="Ejecución de Metas Mensuales" HeaderText="Ingreso de<br/>Ejecución Mensual" CommandName="Select" 
                                      UniqueName="BotonA" ButtonType="ImageButton" ImageUrl="../Iconos/TareaRegional.png" ButtonCssClass="imageButtonClass">
                                     <HeaderStyle HorizontalAlign="Center" Font-Size="8" Font-Names="Arial"/>
                                     <ItemStyle HorizontalAlign="Center"/>
                                    </telerik:GridButtonColumn>                                           
                                     ...
                                     <ItemStyle HorizontalAlign="Center"/>
                                      ...
                                      <telerik:GridBoundColumn DataField="Id_Subregion" UniqueName="Id_Subregion" Visible="false"></telerik:GridBoundColumn>   
                                       ...
                                       <telerik:GridBoundColumn DataField="EstadoDeAsignacion" UniqueName="EstadoDeAsignacion" Visible="false"></telerik:GridBoundColumn>                                      
                                      ...
                                      <telerik:GridBoundColumn DataField="Etapa" UniqueName="Etapa" HeaderText="Etapa">
                                        ...
                                        <telerik:GridBoundColumn DataField="Nombre_Region"  UniqueName="Nombre_Region" HeaderText="Dirección">
                                           <HeaderStyle Font-Size="8" HorizontalAlign="Center" Font-Names="Arial"/>
                                           <ItemStyle HorizontalAlign="Left" Font-Size="8" ForeColor="RoyalBlue" Font-Names="Arial"/>                                           
                                      </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="Subregion" UniqueName="Subregion" HeaderText="Unidad">
                                           <HeaderStyle Font-Size="8" HorizontalAlign="Center" Font-Names="Arial"/>
                                           <ItemStyle HorizontalAlign="Left" Font-Size="8" ForeColor="RoyalBlue" Font-Names="Arial"/>                                           
                                      </telerik:GridBoundColumn>
                      ...
                      <telerik:RadPageView ID="Region_" runat="server" Height="100%"><br/>
                                <div id="Regiones" runat="server">                                 
                                        <telerik:RadGrid ID="RdRegion" runat="server" ShowStatusBar="true" AutoGenerateColumns="False" GridLines="Both" Culture="es-GT" Skin="Office2007"
                                          PageSize="50" AllowSorting="false" AllowMultiRowSelection="False" AllowPaging="True" AllowFilteringByColumn="false">
                                     <PagerStyle Mode="NumericPages"></PagerStyle>
                                    <MasterTableView DataKeyNames="Id_Region,Cod_Padre,Id_Estado_Region" AllowMultiColumnSorting="True" Name="Region">
                                    <DetailTables>
                           ...
                           <br/>
                            <telerik:RadGrid runat="server" ID="GdrDatosdeActividades2" AutoGenerateColumns="False" Width="100%" 
                              ...
                              <div id="Tareas_Regiones" runat="server" visible="false">
                                 <telerik:radwindowmanager ID="RadWindowManager3" runat="server" RenderMode="Classic" EnableShadow="true" Skin="Office2007"></telerik:radwindowmanager>                        
                                <telerik:RadGrid runat="server" ID="GridTareaP_regiones" AutoGenerateColumns="False" Width="100%" AllowSorting ="false" AllowFilteringByColumn="false" AllowPaging="True" 
                                   GridLines="Both" Culture="es-GT" Skin="Office2007" ShowStatusBar ="True" ShowGroupPanel="false">
                                   <GroupingSettings CaseSensitive="False" />
                                      <ClientSettings EnableRowHoverStyle="true" AllowColumnsReorder="True">
                                      <Selecting AllowRowSelect="True"></Selecting>                                      
