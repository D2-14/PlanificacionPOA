<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExportarExcelPOA.aspx.cs" Inherits="PlanificacionPOA.ExportarExcel.ExportarExcelPOA" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <telerik:RadGrid runat="server" ID="GdrConfiguracion" AutoGenerateColumns="False" Width="100%" AllowSorting ="false" AllowFilteringByColumn="false" AllowPaging="false" 
                                   ...
                                   <MasterTableView DataKeyNames="Id_Componente,DescripcionComponente,Id_SubComponente,Id_ProductoVeficable,DescripcionProductoVeficable,
                                                    Id_MetasRedProgramatica,Id_NoPlanificable,Id_UM1,DescripcionUM1,Id_UM2,DescripcionUM2,Id_UM3,DescripcionUM3,Id_UnidadMedida,
                                                    DescripcionUnidadMedida,PtUM1,PtUM2,PtUM3,StUM1,StUM2,StUM3,ttUM1,ttUM2,ttUM3,CmaUM1,CmaUM2,CmaUM3,
                                                 DescripcionSubComponente,DescripcionComponente,MedioDeVerificacion,DireccionMedioVerificacion" NoMasterRecordsText="Sin Información">                                       
