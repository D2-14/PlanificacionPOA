<%@ Page Title="" Language="C#" MasterPageFile="~/MarcoTrabajo/Site.Master" AutoEventWireup="true" CodeBehind="IngresodeMetasNacionales.aspx.cs" Inherits="PlanificacionPOA.Paginas.IngresodeMetasNacionales" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="card-block">
             <h5 class="m-b-10">Ingreso de Metas Nacionales</h5>
                   <p class="text-muted m-b-10">En este Apartado podra ingresar sus metas a los productos, subproductos y actividades
                       que realizara en su Departamento, Unidad o Parque Nacional</p>    
                             ...
                             <telerik:RadGrid runat="server" ID="GdrDatosdeActividades" AutoGenerateColumns="False" Width="100%" 
                               ...
                               Culture="es-GT" Skin="Office2007" ShowStatusBar ="True" ShowGroupPanel="false">                                   
                                   ...
                                   DataKeyNames="Correlativo_Configuracion,Id_Producto,DescripcionProducto,Id_SubProducto,DescripcionSubProducto,Id_Actividad,DescripcionActividad,
                                                 ...
                                                 ttUM2,ttUM3,CmaUM1,CmaUM2,CmaUM3,Id_Unidad_Evaluada,MedioDeVerificacion" NoMasterRecordsText="Sin Información">                                  
                                       <ColumnGroups>
                                    ...
                                    <Columns>  
                                            <telerik:GridButtonColumn Text="Seleccionar para Configurar metas" HeaderText ="Configuración<br/>UM" 
                                                        CommandName="Select1" UniqueName="BotonC" ButtonType="ImageButton" HeaderStyle-Width="20px" ImageUrl="../Iconos/Agregar.png" 
                                                        ButtonCssClass="imageButtonClass" Display="false">
                                      ...
                                      <telerik:GridButtonColumn Text="Seleccionar para Ingreso de metas" HeaderText ="Ingreso de<br/>Metas" 
                                        ...
                                        <telerik:GridBoundColumn DataField="CmaUM1" UniqueName="CmaUM1" ColumnGroupName="CMA" HeaderText="UM1">
                                         ...
                                         <telerik:GridBoundColumn DataField="DescripcionEvaluada" UniqueName="DescripcionEvaluada" HeaderText="Unidad de<br/>Medida Evaluda">
                                           ...
                                           <telerik:GridButtonColumn Text="Eliminar Actividad" CommandName="Delete" UniqueName="BotonB" HeaderText="Eliminar<br/>Meta" ButtonType="ImageButton" 
                                  ...
                                  <table style="margin:auto;border-collapse:separate;border-spacing:8px;font-size:14px;text-align:center;">                                      
                                      ...
                                      <tr>
                                          <td><telerik:RadNumericTextBox ID="txtum1" runat="server" Width="120px" style="text-align:right;"  MinValue="0" 
                                              onkeydown="return (event.keyCode!=13);" Skin="MetroTouch" MaxLength="15" NumberFormat-DecimalDigits="4" 
 ...
 <telerik:RadWindow runat="server" Modal="true" ID="ConfigurarUM" Skin="Office2007" Behaviors="Move" Left="900px" Top="2px">
                    ...
                    <ContentTemplate>                   
                    <div class="panel panel-success">
                        <div class="panel-heading"><div style="text-align:center;"><span class="glyphicon glyphicon-th"></span>&nbsp;&nbsp;<asp:Label ID="Label15" runat="server" Font-Bold="true" Text="Configuración de Unidad a Evaluar (UM)" Font-Size="10"/></div></div>
                        <div class="panel-body">                                                  
                                    <table style="border-collapse:separate;border-spacing:5px;font-size:14px;text-align:center;">  
                                     <tr>
                                       <td style="text-align:right;"><asp:Label ID="Label17" runat="server" Text="Producto:" Font-Bold="true" /></td>
                                       <td style="text-align:justify;font-size:12px;"><asp:Label ID="lblProductos" runat="server" Width="350px"  /></td>
                                   </tr>    
                                     <tr id="Tr1" runat ="server">
                                       <td><asp:Label ID="Label19" runat="server" Text="Subproducto:" Font-Bold="true" /></td>
                                       <td style="text-align:justify;font-size:12px;"><asp:Label ID="lblSubproductos" runat="server" Width="350px"  /></td>
                                   </tr>    
                                   <tr id="Tr2" runat ="server">
                                       <td style="text-align:right;"><asp:Label ID="Label21" runat="server" Text="Actividad:" Font-Bold="true" /></td>
                                       <td style="text-align:justify;font-size:12px;"><asp:Label ID="lblActividads" runat="server" Width="350px"  /></td>
                                   </tr>                                    
                                </table><hr /> 
                                 <table style="margin:auto;border-collapse:separate;border-spacing:0px;font-size:14px;text-align:center;">
                                     <tr><td><asp:Label ID="Label23" runat="server" Text="Unidades de Medida" Font-Bold="true" /></td></tr>
                                  </table>
                                 <table  style="margin:auto;border-collapse:separate;border-spacing:7px;font-size:14px;text-align:center;"> 
                                     <tr>
                                         <td id="Td1" runat="server"><asp:Label ID="Label24" runat="server" Text="UM1:" Font-Bold="true" /></td>
                                         <td id="Td2" runat="server"><asp:Label ID="Label25" runat="server" Text="UM2:" Font-Bold="true" /></td>  
                                         <td id="Td3" runat="server"><asp:Label ID="Label26" runat="server" Text="UM3:" Font-Bold="true" /></td>        
                                    </tr>
                                    <tr>
                                       <td id="Td4" runat="server"><asp:Label ID="LblUM1s" runat="server" Text="UM1" Width="120px"/></td>
                                       <td id="Td5" runat="server"><asp:Label ID="LblUM2s" runat="server" Text="UM2" Width="120px"/></td> 
                                       <td id="Td6" runat="server"><asp:Label ID="LblUM3s" runat="server" Text="UM3" Width="120px"/></td>
                                    </tr>                                       
                                </table><hr />
                                <table style="margin:auto;border-collapse:separate;border-spacing:5px;font-size:12px;text-align:center;">
                                      <tr><td><asp:Label ID="Label30" runat="server" Text="Unidad Evaluada" Font-Bold="true" /></td></tr>
                                    <tr>
