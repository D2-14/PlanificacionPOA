<%@ Page Title="" Language="C#" MasterPageFile="~/MarcoTrabajo/Site.Master" AutoEventWireup="true" CodeBehind="Tarea_Monitoreo_DirectorNacional.aspx.cs" Inherits="PlanificacionPOA.Paginas.Tarea_Monitoreo_DirectorNacional" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-header card">
        <div class="card-block">
             <h5 class="m-b-10">Tareas Asignadas al Director Nacional</h5>
                   <p class="text-muted m-b-10">En este Apartado estan las tareas asignadas al director Nacional de parte de Monitoreo y seguimiento
                      ...
                      <ContentTemplate>
                          <telerik:radwindowmanager ID="RadWindowManager1" runat="server" RenderMode="Classic" EnableShadow="true" Skin="Office2007"></telerik:radwindowmanager>                        
                               <telerik:RadGrid runat="server" ID="GridTareaP" AutoGenerateColumns="False" Width="100%" AllowSorting ="false" AllowFilteringByColumn="false" AllowPaging="True" 
                                   ...
                                   <Columns>  
                                     <telerik:GridButtonColumn Text="Enviar Tareas a a las Jefaturas" HeaderText="Iniciar<br/>Tarea" CommandName="Select" UniqueName="BotonA" ButtonType="ImageButton" ImageUrl="../Iconos/TareaRegional.png" ButtonCssClass="imageButtonClass">
