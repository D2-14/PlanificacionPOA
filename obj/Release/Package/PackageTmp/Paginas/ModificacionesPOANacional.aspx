<%@ Page Title="" Language="C#" MasterPageFile="~/MarcoTrabajo/Site.Master" AutoEventWireup="true" CodeBehind="ModificacionesPOANacional.aspx.cs" Inherits="PlanificacionPOA.Paginas.ModificacionesPOANacional" %>
    ...
    <script type="text/javascript">
     ...
     <div class="page-header card">
        <div class="card-block">
             <h5 class="m-b-10">Modificaciones del POA'S Nacional</h5>
                   <p class="text-muted m-b-10">En este Apartado  se podra visualizar las Modificaciones que se le hicieron al poa </p>          
                      ...
                      <div class="panel panel-success">                        
                          ...
                          <div class="panel-body">
                              ...
                              <telerik:RadGrid runat="server" ID="GdrCambios" AutoGenerateColumns="False" Width="100%" AllowSorting ="True" AllowFilteringByColumn="true" AllowPaging="True" 
                                   ...
                                   DataKeyNames="Id_Producto,Id_SubProducto,Id_Actividad,Mes,Cuatrimestre,Producto,SubProducto,Actividad,UM1A,UM2A,UM3A,UM1AC,UM2AC,UM3AC,Fecha,BreveDescripcion" NoMasterRecordsText="Sin Información">
                                   <RowIndicatorColumn Visible="False"></RowIndicatorColumn>
                                    ...
                                    <Columns>                                           
                                        ...
                                        <telerik:GridBoundColumn DataField="Producto" UniqueName="Producto" FilterControlWidth="100%" 
	                                        ...
	                                        <telerik:GridBoundColumn DataField="SubProducto" UniqueName="SubProducto" FilterControlWidth="100%" 
	                                        ...
	                                        <telerik:GridBoundColumn DataField="Actividad" UniqueName="Actividad" FilterControlWidth="100%" 
                                         ...
                                         <telerik:GridBoundColumn DataField="Cuatrimestre" UniqueName="Cuatrimestre" FilterControlWidth="100%" 
                                                AutoPostBackOnFilter="true" ShowFilterIcon="false" CurrentFilterFunction="Contains" HeaderText="Cuatrimestre">
                                                <HeaderStyle  Font-Size="8" HorizontalAlign="Center" Font-Names="Arial"/>
                                                <ItemStyle HorizontalAlign="Justify" Font-Size="8" ForeColor="RoyalBlue" Font-Names="Arial"/>                                           
                                            </telerik:GridBoundColumn>
