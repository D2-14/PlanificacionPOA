<%@ Page Title="" Language="C#" MasterPageFile="~/MarcoTrabajo/Site.Master" AutoEventWireup="true" CodeBehind="CatalogoPoaNacionalPlanificacion.aspx.cs" Inherits="PlanificacionPOA.Paginas.CatalogoPoaNacionalPlanificacion" %>
    ...
    <telerik:radwindowmanager ID="RadWindowManager1" runat="server" RenderMode="Classic" EnableShadow="true" Skin="Office2007"></telerik:radwindowmanager>
     <div class="page-header card">
         <div class="card-block">
            ...
            <p class="text-muted m-b-10">En este apartado se crearan los Productos, Subproductos, Actividades y configuración de unidades de medida (UM) Nacionales para la planificación Operativa Anual</p>
              <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                 <ContentTemplate>
                      <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;"> 
                                        ...
                                        <tr><td><asp:Label ID="tituloum" runat="server" Font-Bold="true" Font-Size="10" ForeColor="#ff0000"/></td></tr>
             ...
             <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                 <ContentTemplate>                    
                       <table style="border-collapse:separate;border-spacing:2px;font-family:Arial;font-size:13px;font-weight:bold;">
                        <tr><td><asp:LinkButton ID="RegresarPantallaanterior" runat="server" CssClass="btn btn-warning btn-sm" ToolTip="Regresar al modulo anterior"  Text="Guardar"><span class="glyphicon glyphicon-fast-backward"></span>&nbsp;Regresar Módulo anterior Mantenimiento</asp:LinkButton></td></tr>
                    </table>
                                 ...
                                 <table style="border-collapse:separate;border-spacing: 10px;">
                                  ...
                                  <div id="IngresoConfiguracionUM" runat="server">                                                                     
                                       <table style="margin:auto;border-collapse:separate;border-spacing:5px;">  
                                           ...
                                           <tr><td><telerik:RadComboBox ID="CboActividadUM" Skin="MetroTouch" AutoPostBack="true" runat="server" Filter="Contains" EmptyMessage="Seleccione SubProducto" DropDownWidth="500" Width="400px" Height="280"></telerik:RadComboBox></td></tr>                                          
                                       </table>                                       
