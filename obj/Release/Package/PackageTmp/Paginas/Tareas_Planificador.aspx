<%@ Page Title="" Language="C#" MasterPageFile="~/MarcoTrabajo/Site.Master" AutoEventWireup="true" CodeBehind="Tareas_Planificador.aspx.cs" Inherits="PlanificacionPOA.Paginas.Tareas_Planificador" %>
   ...
   <script type="text/javascript">
    ...
    <div class="page-header card">
        <div class="card-block">
             <h5 class="m-b-10">Tareas Asignadas al (ENCARGADO PLANIFICACIÓN)</h5>
                   <p class="text-muted m-b-10">En este Apartado estan las tareas asignadas que tenga el encargado de planificación puede pre Aprobar, denegar las actividades que le ingresaron
                       informacion las direcciones subregionales, ademas de revisar la información por mes o cuatrimestre que enviaron
                   </p>
                  ...
                  <li>
                       <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                             ...
                             <table style="border-collapse:separate;border-spacing:5px;font-family:Arial;font-size:13px;font-weight:bold;">
                               ...
                               <tr>
                            ...
                            </table><br /><%--visualizacion de metas por producto y subproducto--%>
                                ...
                                <div id="CambiosPOA" runat="server" visible="false"><hr />
                                    <table style="margin:auto;border-collapse:separate;border-spacing: 10px;"> 
                                    <tr><td><asp:Label ID="Label1" runat="server" ForeColor="Red" Font-Bold="true" Text="Consulta de Cambios en valores UM" Font-Size="15"/></td></tr>
                                </table> 
                                    <table>
                                        <tr>
