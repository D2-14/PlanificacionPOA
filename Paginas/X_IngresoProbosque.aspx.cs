...
{
    public partial class X_IngresoProbosque : System.Web.UI.Page
    {
        ...
        protected void Seleccionar_Productos(object sender, GridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Select")
            {
                ...
                if ((Producto == 185)  || (Producto == 194) || (Producto == 189)|| (Producto == 201) || 
                     (Producto == 199) )
                {
                    ...
                    t4.Visible = true;
                    tmes.Visible = false;
                    procesos.LLenarComboT(CboModalidad,"SELECT Id_Modalidad Id,Descripcion  FROM Modalidad_ProboqueMonitoreo WHERE Estado = 1;", "Descripcion", "Id", true);
                    Guardar.Visible = true;
                }                
                if ((Producto == 186) || (Producto == 187) || (Producto == 188) || (Producto == 190) || (Producto == 191) || (Producto == 196) || (Producto == 200) || (Producto == 197) || (Producto == 202) || (Producto == 203))
                ...
                if ((Producto == 288)|| (Producto == 289)|| (Producto == 290)|| (Producto == 291)|| (Producto == 292)|| (Producto == 293)|| (Producto == 294)
                    || (Producto == 295) || (Producto == 296)
                    )
                {
                    Guardar.Visible = true;
                    //FECHA
                    ...
                    // Cristian Rejo 22-01-25
                    if ((Producto == 192)||(Producto == 184)||(Producto == 198)||(Producto == 193)||(Producto == 195)||(Producto == 204)) 
                {
                    observa.Visible = true;
                    t1.Visible = true;
                    t2.Visible = true;
        ...
        {
            DatosMonitoreoIngresoMetas DMI = (DatosMonitoreoIngresoMetas)Session["DatosMonitoreoIngresoMetasENVIO"];
            string CadenaSql = "Sp_obtener_data_GridProductosMonitoreo " + 4 + "," + DMI.Id_PoAnual + "," + DMI.Id_Subregion + "," + DMI.IdComponente
        ...
        protected void GrdIngresoEncabezado_ItemDataBound(object sender, GridItemEventArgs e)
        {
            ...
            if (e.Item is GridDataItem)
            {
                ...
                GrdIngresoEncabezado.MasterTableView.GetColumn("BotonA").Display = VPC.ShowHideProductoProbosque(Producto, 1);
                /*validar Valores 0*/
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            ...
            EncabezadoProbosqueIngreso Generico = new EncabezadoProbosqueIngreso();
            ManejoInformacionMonitoreo Mim = new ManejoInformacionMonitoreo();
            ...
            //Aprobacion
            if (Generico.Id_Subcomponente == 29) { Generico.Tipo_SubComponente = 1; }
            //Certificacion
            if (Generico.Id_Subcomponente == 30) { Generico.Tipo_SubComponente = 2; }
            ...
            v = Validar.Campos_Obligatorio_Probosque(Generico, RadDocumentoVerificacion,Mantenimiento);
            if (v.Verificar)
            {
            ...
            else
            {
                ...
                XmlDocument DescripcionProducto = Mim.DetalleXMLProductoProbosque(Generico);
                if (Mim.GuardarItemEncabezadoApi(1, DMI, DescripcionProducto, DescripcionProductoAPI, ref er))
                {
                    if ((Producto != 186) || (Producto != 187) || (Producto != 188) || (Producto != 190) || (Producto != 191) ||
                        (Producto != 196) || (Producto != 197) || (Producto != 200) || (Producto != 202) || (Producto != 203))
                    {
        ...
        protected void Eliminar_Items(object source, GridCommandEventArgs e)
        {
            ...
            {
                if (Mim.Eliminacion_Producto(4, edm, ref er))
                {
                    RecargarGrid();
                }
                else
        ...
        protected void Seleccionar_Items(object sender, GridCommandEventArgs e)
        {
            ...
            if (Llave == 0)
            {
                    ...
                    (Producto == 196) || (Producto == 197) || (Producto == 200) || (Producto == 202) || (Producto == 203))
                {
                    ...
                    {
                        Label41.Text = "Número de Resolución de Certificación:";
