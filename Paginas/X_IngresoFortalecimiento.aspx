<%@ Page Title="" Language="C#" MasterPageFile="~/MarcoTrabajo/Site.Master" AutoEventWireup="true" CodeBehind="X_IngresoFortalecimiento.aspx.cs" Inherits="PlanificacionPOA.Paginas.X_IngresoFortalecimiento" %>
                  ...
                  <div id="Informacion" runat="server" visible="false">
                          ...
                          <div class="panel panel-success">
                           <div class="panel-heading" style="text-align:center;"></div>
                               ...
                               <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="tbl2" runat="server" visible="false">
                                 <tr>
                                     <td><asp:Label ID="Label19" runat="server" Font-Bold="true" Text="Nombre del Documento" Font-Size="10" ForeColor="#006699"/></td>
                                     <td style="width:20px"></td>
                                     <td><asp:Label ID="Label20" runat="server" Font-Bold="true" Text="Año de Vigencia de la Política" Font-Size="10" ForeColor="#006699"/></td>
                                 </tr>
                                   <tr>
                                     <td><asp:TextBox ID="txtnombreDocumento" Font-Names="Arial" Font-Size="9" runat="server" Width="250px" ForeColor="#006699"></asp:TextBox></td>
                                     <td style="width:20px"></td>
                                     <td><telerik:RadNumericTextBox ID="txtAnioVigencia" runat="server" Width="250px" style="text-align:right;" MinValue="0" 
                                              onkeydown="return (event.keyCode!=13);" MaxLength="10" NumberFormat-DecimalDigits="0" 
                                              NumberFormat-DecimalSeparator="."></telerik:RadNumericTextBox></td>
                                 </tr>
                              </table> 
                               <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="puestoEjecuta" runat="server" visible="false">
                                    <tr><td><asp:Label ID="LblTitulo1" runat="server" Font-Bold="true" Text="Puesto Quien Ejecuta la Actividad" Font-Size="10" ForeColor="#006699"/></td></tr>                                       
                                     <tr><td><telerik:RadComboBox ID="CboPuestoEjecuta" runat="server" Filter="Contains" EmptyMessage="Seleccione Puesto quien Ejecuta la Actividad" Width="600px"></telerik:RadComboBox></td></tr> 
                               </table>
                               <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="TblPrimero" runat="server" visible="false">
                                  <tr>
                                       <td><asp:Label ID="Label18" runat="server" Font-Bold="true" Text="Ubicación (Aldea, Cantón, Zona)" Font-Size="10" ForeColor="#006699"/></td>
                                       <td style="width:20px"></td>
                                     <td><asp:Label ID="Label17" runat="server" Font-Bold="true" Text="Comunidad U Organización" Font-Size="10" ForeColor="#006699"/></td>                                                                        
                                 </tr>
                                 <tr>                                                                          
                                     <td><asp:TextBox ID="txtUbicacionDireccion" Font-Names="Arial" Font-Size="9" runat="server" Width="250px" ForeColor="#006699"></asp:TextBox></td>
                                     <td style="width:20px"></td>
                                     <td><asp:TextBox ID="txtComunidadDireccion" Font-Names="Arial" Font-Size="9" runat="server" Width="250px" ForeColor="#006699"></asp:TextBox></td>
                                 </tr>
                               </table> 
                               <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="tbl2_1" runat="server" visible="false">
                                    <tr><td><asp:Label ID="Label16" runat="server" Font-Bold="true" Text="Acciones de Seguimiento(Cuando Aplique)" Font-Size="10" ForeColor="#006699"/></td></tr>                                       
                                     <tr><td><asp:TextBox ID="txtAcciones" Font-Names="Arial" Font-Size="9"    
                                            runat="server" class="form-control" Width="600px" Height="40px" TextMode="MultiLine" ForeColor="#006699"></asp:TextBox></td></tr> 
                               </table>
                               <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="tblTercero" runat="server" visible="false">
                                   <tr>
                                     <td><asp:Label ID="Label27" runat="server" Font-Bold="true" Text="Tipo de Actores" Font-Size="10" ForeColor="#006699"/></td>                                     
                                     <td style="width:20px"></td>
                                    <td><asp:Label ID="Label28" runat="server" Font-Bold="true" Text="Actores" Font-Size="10" ForeColor="#006699"/></td>
                                   </tr>
                                   <tr>
                                   <td><telerik:RadComboBox ID="CboActor" AutoPostBack="true" runat="server" Filter="Contains" EmptyMessage="Seleccione tipo de Actor" Width="250px" Height="90px"></telerik:RadComboBox></td>                                       
                                   <td style="width:20px"></td>
                                   <td><telerik:RadComboBox ID="CboTipoActor" AutoPostBack="true" runat="server" Filter="Contains" EmptyMessage="Seleccione el Tipo" Width="250px" Height="90px"></telerik:RadComboBox></td>   
                                  </tr>
                               </table> 
                              <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="tblSegundo" runat="server" visible="false">
                                 <tr>
                                     <td><asp:Label ID="Label14" runat="server" Font-Bold="true" Text="Nombre del Actor" Font-Size="10" ForeColor="#006699"/></td>
                                     <td style="width:20px"></td>
                                     <td><asp:Label ID="Label15" runat="server" Font-Bold="true" Text="Tema Atendido" Font-Size="10" ForeColor="#006699"/></td>
                                 </tr>
                                 <tr>
                                     <td><asp:TextBox ID="ttxNombreActor" Font-Names="Arial" Font-Size="9" runat="server" Width="250px" ForeColor="#006699"></asp:TextBox></td>
                                     <td style="width:20px"></td>
                                     <td><asp:TextBox ID="txttemaAtendido" Font-Names="Arial" Font-Size="9" runat="server" Width="250px" ForeColor="#006699"></asp:TextBox></td>
                                 </tr>
                              </table>     
                ...
                <telerik:RadWindow runat="server" Modal="true" ID="VerDatosExtra" Skin="Office2007" Behaviors="Move,Close" Left="900px" Top="2px">
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body"> 
                            <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="V3" runat="server" visible="false"> 
                                  <tr>
                                  <td><asp:Label ID="Label23" runat="server" Font-Bold="true" Text="Nombre del Documento:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="lbldocumento" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                                <tr>
                                  <td><asp:Label ID="Label24" runat="server" Font-Bold="true" Text="Año de Vigencia de la Politica:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td style="text-align:right;"><asp:Label ID="lblanio" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>   
                             </table> 
                            <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="V1" runat="server" visible="false"> 
                                 <tr>
                                    <td><asp:Label ID="Label21" runat="server" Font-Bold="true" Text="Puesto Quien Ejecuta la Actividad" Font-Size="10" Width="200px" ForeColor="#006600"/></td>
                                    <td><asp:Label ID="lblActividad" runat="server" Font-Bold="true" Font-Size="10" Width="200px" ForeColor="#000066"/></td>
                                </tr>
                            </table>
                             <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="V5" runat="server" visible="false"> 
                                 <tr>
                                    <td><asp:Label ID="Label25" runat="server" Font-Bold="true" Text="Tipo De Actores" Font-Size="10" Width="200px" ForeColor="#006600"/></td>
                                    <td><asp:Label ID="lblTipoActor" runat="server" Font-Bold="true" Font-Size="10" Width="200px" ForeColor="#000066"/></td>
                                </tr>
                                  <tr>
                                    <td><asp:Label ID="lbltituloActor" runat="server" Font-Bold="true" Text="Actor" Font-Size="10" Width="200px" ForeColor="#006600"/></td>
                                    <td><asp:Label ID="lblActorT" runat="server" Font-Bold="true" Font-Size="10" Width="200px" ForeColor="#000066"/></td>
                                </tr>
                             </table> 
                             <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="V2" runat="server" visible="false"> 
                                 <tr>
                                  <td><asp:Label ID="Label22" runat="server" Font-Bold="true" Text="Ubicación(Aldea, Canton, Zona):" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="lblUbicacion" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                                  <tr>
                                  <td><asp:Label ID="Label36" runat="server" Font-Bold="true" Text="Comunidad U Organización:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="lblComunidadorganizacion" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                             </table>                              
                            <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="V4" runat="server" visible="false"> 
                               
                                <tr><td style="text-align:center;" colspan="2"><asp:Label ID="Label35" runat="server" Font-Bold="true" Text="Acciones de Seguimiento(Cuando Aplique)" Font-Size="10" Width="200px" ForeColor="#006600"/></td></tr>
                                <tr><td colspan="2"><asp:Label ID="LblAcciones" runat="server" Font-Bold="true" Font-Size="10" Width="200px" ForeColor="#000066"/></td></tr>                                                                                                                                                                                                                                                                                                      
                            </table> 
                             <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="V10" runat="server" visible="false">                                                              
                                <tr>
                                  <td><asp:Label ID="Label41" runat="server" Font-Bold="true" Text="Nombre del Actor:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="LblActor" runat="server" Font-Bold="true" Width="200px" Text="xxx" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                                <tr>
                                  <td><asp:Label ID="Label40" runat="server" Font-Bold="true" Text="Tema Atendido:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="lbltemaA" runat="server" Font-Bold="true" Width="200px" Text="xxx" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>                                
                            </table>
                             <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="T4s" runat="server">
                                <tr>
                                     <td><asp:Label ID="Label31" runat="server" Font-Bold="true" Text="Observaciones:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="LObserva" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>                                
                             </table>     
                        </div>
                        </div>                         
