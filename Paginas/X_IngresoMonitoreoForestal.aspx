<%@ Page Title="" Language="C#" MasterPageFile="~/MarcoTrabajo/Site.Master" AutoEventWireup="true" CodeBehind="X_IngresoMonitoreoForestal.aspx.cs" Inherits="PlanificacionPOA.Paginas.X_IngresoMonitoreoForestal" %>
                          ...
                          <div class="panel panel-success">
                           <div class="panel-heading" style="text-align:center;"></div>
                               ...
                               <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;">
                                   ...
                                   <br />
                                   <tr id="fechat1" runat="server" visible="false" >
                                       <td><asp:Label ID="LbltituloFecha" runat="server" Font-Bold="true" Text="Fecha" Font-Size="10" ForeColor="#006699"/></td>
                                       <td style="width:20px"></td>
                                       <td><asp:Label ID="Label11" runat="server" Font-Bold="true" Text="Medio de Verificación" Font-Size="10" ForeColor="#006699"/></td>
                                   </tr>
                                   <tr id="fechat2" runat="server" visible="false">
                                   ...
                                   <tr id="t1" runat="server" visible="false">
                                     <td  style="text-align:left;"><asp:Label ID="LblTitulo1" runat="server" Font-Bold="true" Text="Número de Expediente:" Font-Size="10" ForeColor="#006699"/></td>                                      
                                     <td style="width:20px"></td>
                                   ...
                                   <tr id="t2" runat="server" visible="false">
                                     <td style="text-align:left;"><asp:Label ID="Label22" runat="server" Font-Bold="true" Text="Estado:" Font-Size="10" ForeColor="#006699"/></td>                                      
                                     <td style="width:20px"></td>
                                     <td><asp:TextBox ID="txtEstado" Font-Names="Arial" Font-Size="9" runat="server" Width="250px" ForeColor="#006699"></asp:TextBox></td>
                                   </tr>
                                    <tr id="t3" runat="server" visible="false">
                                       <td style="text-align:left;"><asp:Label ID="lblfase" runat="server" Font-Bold="true" Text="Fase Evaluada:" Font-Size="10" ForeColor="#006699"/></td>                                     
                                     <td style="width:20px"></td>
                                    <td><asp:TextBox ID="txtnfaseEvaluada" Font-Names="Arial" Font-Size="9" runat="server" Width="250px" ForeColor="#006699"></asp:TextBox></td>
                                   </tr>
                                   <tr id="t4" runat="server" visible="false">
                                      <td style="text-align:left;"><asp:Label ID="lbledad" runat="server" Font-Bold="true" Text="Edad:" Font-Size="10" ForeColor="#006699"/></td>                                     
                                     <td style="width:20px"></td>
                                       <td><telerik:RadNumericTextBox ID="txtEdad" runat="server" Width="250px" style="text-align:right;" MinValue="0" 
                                              onkeydown="return (event.keyCode!=13);" MaxLength="10" NumberFormat-DecimalDigits="0" 
                                              NumberFormat-DecimalSeparator="."></telerik:RadNumericTextBox></td>                                   
                                   </tr>
                                   <tr id="t5" runat="server" visible="false">
                                      <td style="text-align:left;"><asp:Label ID="Label14" runat="server" Font-Bold="true" Text="Estatus:" Font-Size="10" ForeColor="#006699"/></td>                                     
                                     <td style="width:20px"></td>
                                    <td><asp:TextBox ID="txtEstatus" Font-Names="Arial" Font-Size="9" runat="server" Width="250px" ForeColor="#006699"></asp:TextBox></td>
                                   </tr>
                                    <tr id="t6" runat="server" visible="false">
                                      <td style="text-align:left;"><asp:Label ID="Label17" runat="server" Font-Bold="true" Text="Tipo de Garantía:" Font-Size="10" ForeColor="#006699"/></td>                                     
                                     <td style="width:20px"></td>
                                    <td><telerik:RadComboBox ID="cboTipoGarantia" runat="server" Filter="Contains" EmptyMessage="Seleccione Tipo Garantia" Width="250px" Height="90px"></telerik:RadComboBox></td>
                                   </tr>
                                   <tr id="t7" runat="server" visible="false">
                                      <td style="text-align:left;"><asp:Label ID="lblInforme" runat="server" Font-Bold="true" Text="Número de Informe:" Font-Size="10" ForeColor="#006699"/></td>                                     
                                     <td style="width:20px"></td>
                                     <td><asp:TextBox ID="txtNumeroInforme" Font-Names="Arial" Font-Size="9" runat="server" Width="250px" ForeColor="#006699"></asp:TextBox></td>
                                   </tr>
                                    <tr id="t8" runat="server" visible="false">
                                      <td style="text-align:left;"><asp:Label ID="Label23" runat="server" Font-Bold="true" Text="Especie:" Font-Size="10" ForeColor="#006699"/></td>                                     
                                     <td style="width:20px"></td>
                                    <td><telerik:RadComboBox ID="cboEspecie" runat="server" Filter="Contains" EmptyMessage="Seleccione Especie" Width="250px" Height="90px"></telerik:RadComboBox></td>
                                   </tr>
                                   <tr id="t9" runat="server" visible="false">
                                      <td style="text-align:left;"><asp:Label ID="Label18" runat="server" Font-Bold="true" Text="Volumen:" Font-Size="10" ForeColor="#006699"/></td>                                     
                                     <td style="width:20px"></td>
                                       <td><telerik:RadNumericTextBox ID="txtVolumen" runat="server" Width="250px" style="text-align:right;" MinValue="0" 
                                              onkeydown="return (event.keyCode!=13);" MaxLength="10" NumberFormat-DecimalDigits="2" 
                                              NumberFormat-DecimalSeparator="."></telerik:RadNumericTextBox></td>                                   
                                   </tr>
                               </table>  
                               <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="Coordenada" runat="server" visible="false">
                                   <tr>
                                       <td><asp:Label ID="Label24" runat="server" Font-Bold="true" Text="Coordenada X (6 Digitos)" Font-Size="10" ForeColor="#006699"/></td>
                                       <td style="width:20px"></td>
                                       <td><asp:Label ID="Label26" runat="server" Font-Bold="true" Text="Coordenada Y (7 Digitos)" Font-Size="10" ForeColor="#006699"/></td>
                                   </tr>
                                   <tr>
                                        <td><telerik:RadNumericTextBox ID="txtX" runat="server" Width="250px" style="text-align:right;" MinValue="0" 
                                              onkeydown="return (event.keyCode!=13);" MaxLength="6" NumberFormat-DecimalDigits="0" 
                                              NumberFormat-DecimalSeparator="."></telerik:RadNumericTextBox></td>
                                       <td style="width:20px"></td>
                                       <td><telerik:RadNumericTextBox ID="txtY" runat="server" Width="250px" style="text-align:right;" MinValue="0" 
                               ...
                               <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="tmes" runat="server" visible="false">
                                    <tr><td><asp:Label ID="Label20" runat="server" Font-Bold="true" Text="Mes de Ingreso" Font-Size="10" ForeColor="#006699"/></td></tr>                                       
                              ...
                              <table style="margin-top:10px;border-collapse:separate;border-spacing:5px;text-align:center;" id="observa" runat="server" visible="false">
                                   <tr>
...
<telerik:RadWindow  runat="server" Modal="true" ID="visualizar" Skin="Office2007" Behaviors="Move,Maximize" Left="980px" Top="2px" ReloadOnShow="true">
 ...
 <telerik:RadWindow ID="confirmar" runat="server" Left="900px" Top="2px" Modal="true" Behaviors="None" Skin="Office2007"
                ...
                <telerik:RadWindow runat="server" Modal="true" ID="VerDatosExtra" Skin="Office2007" Behaviors="Move,Close" Left="900px" Top="2px">
                    ...
                    <ContentTemplate>                   
                    <div class="panel panel-success">
                        <div class="panel-heading"><div style="text-align:center;"><span class="glyphicon glyphicon-file"></span>&nbsp;&nbsp;
                            <asp:Label ID="Label34" runat="server" Font-Bold="true" Text="Información Adicional" Font-Size="10"/></div></div>
                        <div class="panel-body"> 
                            <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="T1s" runat="server" visible="false">
                                <tr>
                                  <td><asp:Label ID="tituloFecha" runat="server" Font-Bold="true" Text="9999" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="lblFecha" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>                                
                             </table> 
                            <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="T13s" runat="server" visible="false">
                                <tr>
                                     <td><asp:Label ID="Label27" runat="server" Font-Bold="true" Text="Especie" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="lblEspecie" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>                                
                             </table> 
                            <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="T2s" runat="server" visible="false"> 
                                <tr>
                            ...
                            <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="T3s" runat="server" visible="false">
                                <tr><td><asp:Label ID="Label10" runat="server" Font-Bold="true" Text="Número de Resolución:" Font-Size="10" Width="200px" ForeColor="#006600"/></td>
                                    <td><asp:Label ID="LblResolucion" runat="server" Font-Bold="true" Font-Size="10" Width="200px" ForeColor="#000066"/></td>                                                                                                                                                                       
                                </tr>
                            </table>                                                                              
                            <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="T5s" runat="server" visible="false">
                                <tr>
                                     <td><asp:Label ID="Label16" runat="server" Font-Bold="true" Text="Estado" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="lblestado" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>                                
                             </table> 
                            <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="T6s" runat="server" visible="false">
                                <tr>
                                  <td><asp:Label ID="titulofase" runat="server" Font-Bold="true" Text="Estado" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="lblfases" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>                               
                             </table> 
                            <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="T7s" runat="server" visible="false">
                                <tr> 
                                <td><asp:Label ID="Label15" runat="server" Font-Bold="true" Text="Estatus" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="lblEstatus" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                    </tr>
                             </table> 
                            <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="T8s" runat="server" visible="false">
                                <tr>
                                 <td><asp:Label ID="tituloEdad" runat="server" Font-Bold="true" Text="Edad" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="Lbledades" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                              </table> 
                             <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="T9s" runat="server" visible="false">
                                 <tr>
                                 <td><asp:Label ID="Label36" runat="server" Font-Bold="true" Text="Tipo de Garantías" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="lblGarantias" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                             </table> 
                             <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="T10s" runat="server" visible="false">
                                 <tr><td><asp:Label ID="tituloInforme" runat="server" Font-Bold="true" Text="Número Informe" Font-Size="10" Width="200px" ForeColor="#006600"/></td>
                                    <td><asp:Label ID="lblinformes" runat="server" Font-Bold="true" Font-Size="10" Width="200px" ForeColor="#000066"/></td>                                                                                                                                                                       
                                </tr>
                             </table> 
                               <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="T11s" runat="server" visible="false">
                                 <tr><td><asp:Label ID="Label25" runat="server" Font-Bold="true" Text="Volumen" Font-Size="10" Width="200px" ForeColor="#006600"/></td>
                                    <td><asp:Label ID="lblVolumen" runat="server" Font-Bold="true" Font-Size="10" Width="200px" ForeColor="#000066"/></td>                                                                                                                                                                       
                                </tr>
                             </table> 
                             <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="T12s" runat="server" visible="false">
                                 <tr><td><asp:Label ID="Label28" runat="server" Font-Bold="true" Text="Coordenada X" Font-Size="10" Width="200px" ForeColor="#006600"/></td>
                                    <td><asp:Label ID="lblcx" runat="server" Font-Bold="true" Font-Size="10" Width="200px" ForeColor="#000066"/></td>                                                                                                                                                                       
                                </tr>
                                 <tr><td><asp:Label ID="Label30" runat="server" Font-Bold="true" Text="Coordenada Y" Font-Size="10" Width="200px" ForeColor="#006600"/></td>
                                    <td><asp:Label ID="lblcy" runat="server" Font-Bold="true" Font-Size="10" Width="200px" ForeColor="#000066"/></td>                                                                                                                                                                       
                                </tr>
                             </table> 
                             <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="T4s" runat="server" visible="false">
                                <tr>
                                     <td><asp:Label ID="Label19" runat="server" Font-Bold="true" Text="Observaciones:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="Lblobservas" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>                                
                             </table>       
                        </div>
                        </div>                         
