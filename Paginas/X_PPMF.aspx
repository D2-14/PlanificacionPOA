<%@ Page Title="" Language="C#" MasterPageFile="~/MarcoTrabajo/Site.Master" AutoEventWireup="true" CodeBehind="X_PPMF.aspx.cs" Inherits="PlanificacionPOA.Paginas.X_PPMF" %>
                          ...
                          <div class="panel panel-success">
                           <div class="panel-heading" style="text-align:center;"></div>
                               ...
                               <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="Resp1" visible="false" runat="server">
                                    <tr><td colspan="3"><asp:Label ID="Label16" runat="server" Font-Bold="true" Text="Tipo de Bosque" Font-Size="10" ForeColor="#006699"/></td></tr>
                                    <tr><td colspan="3"><telerik:RadComboBox ID="CboTipoBosque" AutoPostBack="true" runat="server" Filter="Contains" EmptyMessage="Seleccione tipo de Bosque" Width="500px"></telerik:RadComboBox></td></tr>                                    
                               </table> 
                              <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="Resp2" visible="false" runat="server">
                                  <tr><td colspan="3"><asp:Label ID="Label20" runat="server" Font-Bold="true" Text="Unidad de Muestreo" Font-Size="10" ForeColor="#006699"/></td></tr>
                                  <tr><td colspan="3"><telerik:RadNumericTextBox ID="txtUnidadMuestreo" runat="server" Width="500px" style="text-align:right;" MinValue="0" 
                                              onkeydown="return (event.keyCode!=13);" MaxLength="10" NumberFormat-DecimalDigits="0" 
                                              NumberFormat-DecimalSeparator="."></telerik:RadNumericTextBox></td></tr>
                              </table> 
                              <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="Resp3" visible="false" runat="server">
                                   <tr>
                                       <td><asp:Label ID="Label14" runat="server" Font-Bold="true" Text="Coordenada X" Font-Size="10" ForeColor="#006699"/></td>
                                       <td style="width:20px"></td>
                                       <td><asp:Label ID="Label15" runat="server" Font-Bold="true" Text="Coordenada Y" Font-Size="10" ForeColor="#006699"/></td>
                                   </tr>
                                  <tr>
                              ...
                              <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="Resp4" visible="false" runat="server">
                                  <tr>
                                       <td><asp:Label ID="Label22" runat="server" Font-Bold="true" Text="Fecha de medición" Font-Size="10" ForeColor="#006699"/></td>
                                       <td style="width:20px"></td>
                                       <td><asp:Label ID="Label23" runat="server" Font-Bold="true" Text="Fecha de establecimiento (PPM)" Font-Size="10" ForeColor="#006699"/></td>
                                   </tr>
                                  <tr>
                                       <td><telerik:RadDatePicker ID="Fechaplnatacion" runat="server" Width="250px" onkeydown="return (event.keyCode!=13);"></telerik:RadDatePicker></td>
                                       <td style="width:20px"></td>
                                      <td><telerik:RadDatePicker ID="FechaPPM" runat="server" Width="250px" onkeydown="return (event.keyCode!=13);"></telerik:RadDatePicker></td>
                                  </tr>
                               </table> 
                              <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="Resp5" visible="false" runat="server">
                                  <tr>
                                       <td><asp:Label ID="Label24" runat="server" Font-Bold="true" Text="Nombre del sitio" Font-Size="10" ForeColor="#006699"/></td>
                                       <td style="width:20px"></td>
                                       <td><asp:Label ID="Label25" runat="server" Font-Bold="true" Text="Número de Experimiento" Font-Size="10" ForeColor="#006699"/></td>
                                   </tr>
                                  <tr>
                                      <td><asp:TextBox ID="txtNombresitio" Font-Names="Arial" Font-Size="10" runat="server" Width="250px" ForeColor="#006699"></asp:TextBox></td>
                                      <td style="width:20px"></td>
                                       <td><telerik:RadNumericTextBox ID="txtNoExperimento" runat="server" Width="250px" style="text-align:right;" MinValue="0" 
                                              onkeydown="return (event.keyCode!=13);" MaxLength="10" NumberFormat-DecimalDigits="0" 
                                              NumberFormat-DecimalSeparator="."></telerik:RadNumericTextBox></td>
                                  </tr>
                                  <tr>
                                       <td><asp:Label ID="Label26" runat="server" Font-Bold="true" Text="Número de Parcela" Font-Size="10" ForeColor="#006699"/></td>
                                       <td style="width:20px"></td>
                                       <td><asp:Label ID="Label27" runat="server" Font-Bold="true" Text="Número de Medición" Font-Size="10" ForeColor="#006699"/></td>
                                   </tr>
                                  <tr>
                                    <td><telerik:RadNumericTextBox ID="txtNoParcela" runat="server" Width="250px" style="text-align:right;" MinValue="0" 
                                              onkeydown="return (event.keyCode!=13);" MaxLength="10" NumberFormat-DecimalDigits="0" 
                                              NumberFormat-DecimalSeparator="."></telerik:RadNumericTextBox></td>
                                       <td style="width:20px"></td>
                                    <td><telerik:RadNumericTextBox ID="txtNoMedcion" runat="server" Width="250px" style="text-align:right;" MinValue="0" 
                                              onkeydown="return (event.keyCode!=13);" MaxLength="10" NumberFormat-DecimalDigits="0" 
                                              NumberFormat-DecimalSeparator="."></telerik:RadNumericTextBox></td>
                                  </tr>
                                  <tr id="Resp5_1" runat="server" visible="false">
                                      <td><asp:Label ID="Label29" runat="server" Font-Bold="true" Text="Código del Proyecto" Font-Size="10" ForeColor="#006699"/></td> 
                                       <td style="width:20px"></td>
                                       <td><asp:Label ID="Label28" runat="server" Font-Bold="true" Text="Replanteo (%)" Font-Size="10" ForeColor="#006699"/></td>                                      
                                  </tr>
                                  <tr id="Resp5_2" runat="server" visible="false">
                                       <td><asp:TextBox ID="txtCodigoProyecto" Font-Names="Arial" Font-Size="10" runat="server" Width="250px" ForeColor="#006699"></asp:TextBox></td>
                                      <td style="width:20px"></td>
                                      <td><telerik:RadNumericTextBox ID="txtReplanteo" runat="server" Width="250px" style="text-align:right;" MinValue="0" 
                                              onkeydown="return (event.keyCode!=13);" MaxLength="3" NumberFormat-DecimalDigits="2" 
                                              NumberFormat-DecimalSeparator="."></telerik:RadNumericTextBox></td>
                                  </tr> 
                              </table> 
                              <table style="margin:10px;border-collapse:separate;border-spacing:5px;text-align:center;" id="observa" runat="server">
                                   <tr>
                                      <td><asp:Label ID="Label12" CssClass="m-t-15" runat="server" Font-Bold="true" Text="Observaciones" Font-Size="10" ForeColor="#006699"/></td>
                                  </tr>
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body"> 
                             <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" visible="false" id="R1" runat="server">
                                 <tr>
                                    <td><asp:Label ID="Label30" runat="server" Font-Bold="true" Text="Tipo de Bosque:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>    
                                    <td><asp:Label ID="Ltipobosque" runat="server" Font-Bold="true" Width="200px"  Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                             </table> 
                            <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" visible="false" id="R2" runat="server">
                                <tr>
                                    <td><asp:Label ID="Label31" runat="server" Font-Bold="true" Text="Unidad de Muestreo:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>    
                                    <td><asp:Label ID="LUnidadMuestreo" runat="server" Font-Bold="true" Width="200px"  Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                            </table> 
                            <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" visible="false" id="R3" runat="server">
                                <tr>
                                    <td><asp:Label ID="Label17" runat="server" Font-Bold="true" Text="Coordenada X:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>    
                                    <td><asp:Label ID="Lcoordenadax" runat="server" Font-Bold="true" Width="200px"  Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                                <tr>
                                    <td><asp:Label ID="Label21" runat="server" Font-Bold="true" Text="Coordenada Y:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>    
                                    <td><asp:Label ID="Lcoordenaday" runat="server" Font-Bold="true" Width="200px"  Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                            </table> 
                            <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" visible="false" id="R4" runat="server">
                                <tr>
                                    <td><asp:Label ID="Label19" runat="server" Font-Bold="true" Text="Fecha de medición:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>    
                                    <td><asp:Label ID="Lfechaplantacion" runat="server" Font-Bold="true" Width="200px"  Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                                <tr>
                                    <td><asp:Label ID="Label33" runat="server" Font-Bold="true" Text="Fecha de establecimiento (PPM):" Width="200px" Font-Size="10" ForeColor="#006600"/></td>    
                                    <td><asp:Label ID="LfechaPPM" runat="server" Font-Bold="true" Width="200px"  Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                            </table> 
                             <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" visible="false" id="R5" runat="server">
                                 <tr>
                                    <td><asp:Label ID="Label32" runat="server" Font-Bold="true" Text="Nombre del sitio:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>    
                                    <td><asp:Label ID="LNombresitio" runat="server" Font-Bold="true" Width="200px"  Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                                  <tr>
                                    <td><asp:Label ID="Label35" runat="server" Font-Bold="true" Text="Número de Experimento:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>    
                                    <td><asp:Label ID="LNoExperimento" runat="server" Font-Bold="true" Width="200px"  Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                                 <tr>
                                    <td><asp:Label ID="Label36" runat="server" Font-Bold="true" Text="Numero de Parcela:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>    
                                    <td><asp:Label ID="LNoParcela" runat="server" Font-Bold="true" Width="200px"  Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                                <tr>
                                    <td><asp:Label ID="Label38" runat="server" Font-Bold="true" Text="Número de Medición:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>    
                                    <td><asp:Label ID="LNomedicion" runat="server" Font-Bold="true" Width="200px"  Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                             </table>   
                             <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" visible="false" id="R6" runat="server">
                                 <tr>
                                    <td><asp:Label ID="Label39" runat="server" Font-Bold="true" Text="Codigo de Proyecto:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>    
                                    <td><asp:Label ID="LcodigoProyecto" runat="server" Font-Bold="true" Width="200px"  Font-Size="10" ForeColor="#000066"/></td>
                                </tr>      
                                  <tr>
                                    <td><asp:Label ID="Label37" runat="server" Font-Bold="true" Text="Replanteo (%):" Width="200px" Font-Size="10" ForeColor="#006600"/></td>    
                                    <td><asp:Label ID="LReplanteo" runat="server" Font-Bold="true" Width="200px"  Font-Size="10" ForeColor="#000066"/></td>
                                </tr>                                  
                              </table> 
