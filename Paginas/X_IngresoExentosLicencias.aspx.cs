...
{
    public partial class X_IngresoExentosLicencias : System.Web.UI.Page
    {
        ...
        protected void Seleccionar_Productos(object sender, GridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Select")
            {
                ...
                if ((Producto == 46) || (Producto == 47) || (Producto == 48))
                {
                    ...
                    {
                        cboMesIngreso.SelectedValue.ToString();
                    }
                        Guardar.Visible = true;
                }
                RecargarGrid();
        ...
        protected void GrdIngresoEncabezado_NeedDataSource(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
        {
            ...
            if (cboMesIngreso.SelectedIndex < 0)
            {
                string CadenaSql = "Sp_obtener_data_GridProductosMonitoreo " + 14 + "," + DMI.Id_PoAnual + "," + DMI.Id_Subregion + "," + DMI.IdComponente
        ...
        protected void GrdIngresoEncabezado_ItemDataBound(object sender, GridItemEventArgs e)
        {
            ...
            if (e.Item is GridDataItem)
            {
                ...
                GrdIngresoEncabezado.MasterTableView.GetColumn("BotonA").Display = VPC.ShowHideProductoExentosForestales(Producto, 1);
                /*validar Valores 0*/
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            ...
            EncabezadoExentosIngreso Generico = new EncabezadoExentosIngreso();
            ManejoInformacionMonitoreo Mim = new ManejoInformacionMonitoreo();
            ...
            {
                Generico.Id_Mes = int.Parse(cboMesIngreso.SelectedValue);
            }
            ...
            v = Validar.Campos_Obligatorio_ExentosForestales(Generico, RadDocumentoVerificacion, Mantenimiento);
            if (v.Verificar)
            {
            ...
            else
            {
                ...
                if ((Producto == 46) || (Producto == 47) || (Producto == 48))
                {
                    ...
                    DescripcionProductoAPI = mapi.ExentoForestal(Edapi);
                }
                else
                {
                ...
                XmlDocument DescripcionProducto = Mim.DetalleXMLProductoExentosForestales(Generico);
                if (Mim.GuardarItemEncabezadoApi(4, DMI, DescripcionProducto, DescripcionProductoAPI, ref er)) 
                {
                    if ((Producto != 46) || (Producto != 47) || (Producto != 48))
                    {
        ...
        protected void Eliminar_Items(object source, GridCommandEventArgs e)
        {
            ...
            {
                if (Mim.Eliminacion_Producto(15, edm, ref er))
                {
                    RecargarGrid();
                }
                else
        ...
        protected void Seleccionar_Items(object sender, GridCommandEventArgs e)
        {
            ...
            if (Llave == 0)
            {
                ...
                if ((Producto == 46) || (Producto == 47) || (Producto == 48))
                {
                    ...
                    x1.Visible = false;
                    x2.Visible = true;
                    lblFecha1.Text = item.GetDataKeyValue("Fecha").ToString(); 
                    lblNoExpediente1.Text = item.GetDataKeyValue("NoExpediente").ToString();
                    lblResolucion1.Text = item.GetDataKeyValue("NoResolucion").ToString();
