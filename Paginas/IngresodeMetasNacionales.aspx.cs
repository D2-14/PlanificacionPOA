...
{
    public partial class IngresodeMetasNacionales : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("Tareas_Departamentos.aspx");
        }
        ...
        protected void Seleccionar_Actividad(object sender, GridCommandEventArgs e)
        {
            ...
            else
            {
                ...
                if (e.CommandName == "Select1") 
                {
                    ...
                    lblActividads.Text = Ian.DescripcionActividad;
                    lblProductos.Text = Ian.DescripcionProducto;
                    lblSubproductos.Text = Ian.DescripcionSubProducto;
                    LblUM1s.Text = Ian.DUM1;
                    LblUM2s.Text = Ian.DUM2;
                    LblUM3s.Text = Ian.DUM3;

                    Session["llave"] = 1;
                    Session["CargarMetasValor"] = Ian;
                    OpenWinwdows(ConfigurarUM, "500", "600", "Key10", "Configuración UM");
                }
                if (e.CommandName == "Delete") { Session["llave"] = 1; }
                /*Abrir la ventana*/
        ...
        protected void FinalizarIngreso_Click(object sender, EventArgs e)
        {
            ...
            {
                if (x.Enviar_DirectorJefe(Dt, ref er))
                {
        ...
        /*Agregar Unidades de Medida a las actividades*/
