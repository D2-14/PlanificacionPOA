...
{
    public partial class Tareas_SubRegional : System.Web.UI.Page
    {
        ...
        protected string Grid(int op)
        {
            ...
            string CadenaSQL = "SELECT asr.Id_PoAnual,asr.IdMensaje,asr.Id_Region,asr.Id_Subregion," +
                        ...
                        "FROM AsignacionSubRegion asr INNER JOIN Poas_Creados pc ON pc.Id_PoAnual = asr.Id_PoAnual " +
                ...
                if (op == 1)
                {
                    ...
                    {
                    CadenaSQL += " AND asr.Id_Region =" + Users.id_region + " ORDER BY r.Id_Region,SR.Id_Subregion;";
                }
                    else
                    {
        ...
        protected void Seleccionar_Tarea(object sender, GridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Select")
            {
                ...
                {                    
                    ...
                    if(x.VerificarCarga(dt) == false) 
                    {
                        if (x.Generar_meses_Todos(dt, ref er)) { }
                    }                                        
