<%@ Page Title="" Language="C#" MasterPageFile="~/MarcoTrabajo/Site.Master" AutoEventWireup="true" CodeBehind="X_IncentivoForestales.aspx.cs" Inherits="PlanificacionPOA.Paginas.X_IncentivoForestales" %>
                           ...
                           <div class="panel-heading" style="text-align:center;"></div>
                               ...
                               <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;">
                                   ...
                                   <tr id="t1" runat="server">
                                       ...
                                       <td style="width:20px"></td>
                                       <td><asp:Label ID="Label11" CssClass="m-t-15" runat="server" Font-Bold="true" Text="Medio de Verificación" Font-Size="10" ForeColor="#006699"/></td>
                                   </tr>
                               ...
                               <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="ProductosIncent" visible="false" runat="server">
                                   <tr>
                                       <td><asp:Label ID="Label14" runat="server" Font-Bold="true" Text="Número de Expediente" Font-Size="10" ForeColor="#006699"/></td>
                                       <td style="width:20px"></td>
                                       <td><asp:Label ID="Label15" runat="server" Font-Bold="true" Text="Área" Font-Size="10" ForeColor="#006699"/></td>
                                   </tr>
                                   <tr>
                                       <td><asp:TextBox ID="txtExpediente" Font-Names="Arial" Font-Size="10" runat="server" Width="250px" ForeColor="#006699"></asp:TextBox></td>
                                       <td style="width:20px"></td>
                                        <td><telerik:RadNumericTextBox ID="txtAreaIncentivo" runat="server" Width="250px" style="text-align:right;" MinValue="0" 
                                              onkeydown="return (event.keyCode!=13);" MaxLength="10" NumberFormat-DecimalDigits="2" 
                                              NumberFormat-DecimalSeparator="."></telerik:RadNumericTextBox></td>
                                   </tr>
                                    <tr>
                                       <td><asp:Label ID="Label17" runat="server" Font-Bold="true" Text="Tipo de Incentivo" Font-Size="10" ForeColor="#006699"/></td>
                                       <td style="width:20px"></td>
                                       <td><asp:Label ID="lblIncentivo" runat="server" Font-Bold="true" Text="Incentivo" Font-Size="10" ForeColor="#006699"/></td>
                                   </tr>
                                   <tr>
                                     <td><telerik:RadComboBox ID="CboTipoIncentivo"  AutoPostBack="true" runat="server" Filter="Contains" EmptyMessage="Seleccione Tipo de Incentivo" Width="250px" Height="90px"></telerik:RadComboBox></td>
                                       <td style="width:20px"></td>
                                     <td><telerik:RadComboBox ID="cboIncetivos" AutoPostBack="true" runat="server" Filter="Contains" EmptyMessage="Seleccione la Modalidad" Width="250px" Height="90px"></telerik:RadComboBox></td>  
                              
                                   </tr>
                                   <tr><td colspan="3"><asp:Label ID="Label19" runat="server" Font-Bold="true" Text="Fase de Proyecto" Font-Size="10" ForeColor="#006699"/></td></tr>
                                   <tr><td colspan="3"><telerik:RadComboBox ID="CboFaseProyecto" runat="server" Filter="Contains" EmptyMessage="Seleccione Fase de Proyecto" Width="500px" Height="90px"></telerik:RadComboBox></td></tr>
                               </table> 
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">                                                  
                            <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="x1" runat="server" visible="false"> 
                                ...
                                <tr><td><asp:Label ID="Label35" runat="server" Font-Bold="true" Text="Area:" Font-Size="10" Width="200px" ForeColor="#006600"/></td>
                                    <td style="text-align:right;"><asp:Label ID="LblArea" runat="server" Font-Bold="true" Font-Size="10" Width="200px" ForeColor="#000066"/></td>                                                                                                                                                                       
                                </tr>
                                <tr>
                                  <td><asp:Label ID="Label36" runat="server" Font-Bold="true" Text="Tipo de Incentivo" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="lblTipoIncentivo" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr> 
                                <tr>
                                  <td><asp:Label ID="Label16" runat="server" Font-Bold="true" Text="Modalidad de Incentivo" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="lblModalidad" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr> 
                                 <tr>
                                  <td><asp:Label ID="Label20" runat="server" Font-Bold="true" Text="Fase de Proyecto" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
