<%@ Page Title="" Language="C#" MasterPageFile="~/MarcoTrabajo/Site.Master" AutoEventWireup="true" CodeBehind="X_IngresoExentosLicencias.aspx.cs" Inherits="PlanificacionPOA.Paginas.X_IngresoExentosLicencias" %>
                           ...
                           <div class="panel-heading" style="text-align:center;"></div>
                               ...
                               <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="t3" runat="server" visible="false">
                                    <tr>
                                       ...
                                       <td style="width:20px"></td>
                                       <td><asp:Label ID="Label15" runat="server" Font-Bold="true" Text="Número de Resolución" Font-Size="10" ForeColor="#006699"/></td>
                                   </tr>
                                   <tr>
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">                                                  
                            <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="x1" runat="server" visible="false"> 
                                <tr>
                                    <td><asp:Label ID="Label16" runat="server" Font-Bold="true" Text="Fecha:" Font-Size="10" Width="200px" ForeColor="#006600"/></td>
                                    <td><asp:Label ID="lblFecha" runat="server" Font-Bold="true" Font-Size="10" Width="200px" ForeColor="#000066"/></td>
                                </tr>
                                <tr>
                             ...
                             <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="x2" runat="server" visible="false">                               
                                <tr>
                                    <td><asp:Label ID="Label19" runat="server" Font-Bold="true" Text="Fecha:" Font-Size="10" Width="200px" ForeColor="#006600"/></td>
                                    <td><asp:Label ID="lblFecha1" runat="server" Font-Bold="true" Font-Size="10" Width="200px" ForeColor="#000066"/></td>
                                </tr>
                                 <tr>
                                    <td><asp:Label ID="Label20" runat="server" Font-Bold="true" Text="Número de Expediente:" Font-Size="10" Width="200px" ForeColor="#006600"/></td>
                                    <td><asp:Label ID="lblNoExpediente1" runat="server" Font-Bold="true" Font-Size="10" Width="200px" ForeColor="#000066"/></td>
                                </tr>
                                <tr><td><asp:Label ID="Label23" runat="server" Font-Bold="true" Text="Número de Resolución:" Font-Size="10" Width="200px" ForeColor="#006600"/></td>
                                    <td><asp:Label ID="lblResolucion1" runat="server" Font-Bold="true" Font-Size="10" Width="200px" ForeColor="#000066"/></td>                                                                                                                                                                       
                                </tr>
                                 <tr>
                                    <td><asp:Label ID="Label25" runat="server" Font-Bold="true" Text="Numero de Registro:" Font-Size="10" Width="200px" ForeColor="#006600"/></td>
