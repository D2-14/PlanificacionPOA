<%@ Page Title="" Language="C#" MasterPageFile="~/MarcoTrabajo/Site.Master" AutoEventWireup="true" CodeBehind="Tarea_Monitoreo_SubRegion.aspx.cs" Inherits="PlanificacionPOA.Paginas.Tarea_Monitoreo_SubRegion" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
  <div class="page-header card">
        <div class="card-block">
             <h5 class="m-b-10">Tareas Asignadas al SubRegional</h5>
                   <p class="text-muted m-b-10">En este Apartado estan las tareas asignadas al Director SubRegional de parte de Evaluación y Seguimiento Institucional
                       de la Dirección de Planificación, Evaluación y Seguimiento Institucional</p>
                         ...
                         <ContentTemplate>
                          <telerik:radwindowmanager ID="RadWindowManager1" runat="server" RenderMode="Classic" EnableShadow="true" Skin="Office2007"></telerik:radwindowmanager>                        
                               <telerik:RadGrid runat="server" ID="GridTareaP" AutoGenerateColumns="False" Width="100%" AllowSorting ="false" AllowFilteringByColumn="false" AllowPaging="True" 
                                   ...
                                   DataKeyNames="Id_PoAnual,FechaDeAsignacion,Fecha_Inicio,Fecha_Final,EstadoDeAsignacion,Id_Region,Id_Subregion,Subregion,
                                                 IdMensaje,Id_Mes,Instrucciones,POA,mes" NoMasterRecordsText="Sin Información">
                                   <RowIndicatorColumn Visible="False"></RowIndicatorColumn>
                                    <Columns>
                                       <telerik:GridButtonColumn Text="Ingreso de ejecución Mensual" HeaderText="Ingreso de<br/>Ejecución Mensual" 
                                           CommandName="Select" UniqueName="BotonA" ButtonType="ImageButton" ImageUrl="../Iconos/descarga.png" ButtonCssClass="imageButtonClass">
                                     <HeaderStyle Width="60px" HorizontalAlign="Center" Font-Size="8" Font-Names="Arial"/>
                                     ...
                                     <HeaderStyle Width="20px" HorizontalAlign="Center" Font-Size="10" Font-Names="Arial" Font-Bold="true"/>
                                     <ItemStyle HorizontalAlign="Center"/>
                                    </telerik:GridButtonColumn>    
                                      ...
                                      <telerik:GridBoundColumn DataField="Etapa" UniqueName="Etapa" HeaderText="Etapa">
                                        ...
                                        <telerik:GridBoundColumn DataField="Nombre_Region"  UniqueName="Nombre_Region" HeaderText="Región">
                                         ...
                                         <telerik:GridBoundColumn DataField="mes"  UniqueName="mes" HeaderText="Mes de Ejecución">
                                           <HeaderStyle Font-Size="8" HorizontalAlign="Center" Font-Names="Arial"/>
                                           <ItemStyle HorizontalAlign="Center" Font-Size="8" ForeColor="RoyalBlue" Font-Names="Arial"/>                                           
                                      </telerik:GridBoundColumn>                                                                             
