                                ...
                                <telerik:RadGrid runat="server" ID="GridProductos" AutoGenerateColumns="False" Width="100%" AllowSorting ="false" AllowFilteringByColumn="true" AllowPaging="True" 
                                   ...
                                   <RowIndicatorColumn Visible="False"></RowIndicatorColumn>
                                    <Columns> 
                                     ...
                                     <telerik:GridBoundColumn DataField="Proceso" UniqueName="Proceso" AutoPostBackOnFilter="true" AllowFiltering="false" Visible="false" HeaderText="ESTADO DEL INGRESO DE INFORMACIÓN">
