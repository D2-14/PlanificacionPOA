<%@ Page Title="" Language="C#" MasterPageFile="~/MarcoTrabajo/Site.Master" AutoEventWireup="true" CodeBehind="X_IngresoLicenciaForestales.aspx.cs" Inherits="PlanificacionPOA.Paginas.X_IngresoLincenciaForestales" %>
                  ...
                  <div id="Informacion" runat="server" visible="false">
                          ...
                          <div class="panel panel-success">
                           <div class="panel-heading" style="text-align:center;"></div>
                              ...
                              <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="Resp0" runat="server" visible="false">
                                    <tr>
                                       <td><asp:Label ID="Label14" runat="server" Font-Bold="true" Text="Número de Expediente" Font-Size="10" ForeColor="#006699"/></td>
                                       <td style="width:20px"></td>
                                       <td><asp:Label ID="lbltituloresol" runat="server" Font-Bold="true" Text=" " Font-Size="10" ForeColor="#006699"/></td>
                                   </tr>
                                   <tr>
                                       <td><asp:TextBox ID="txtExpediente" Font-Names="Arial" Font-Size="9" runat="server" Width="250px" ForeColor="#006699"></asp:TextBox></td>
                                       <td style="width:20px"></td>
                                       <td><asp:TextBox ID="txtnoResolucion" Font-Names="Arial" Font-Size="9" runat="server" Width="250px" ForeColor="#006699"></asp:TextBox></td>
                                   </tr>
                               </table>
                               <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="Resp5" runat="server" visible="false">
                                    <tr>
                                       <td><asp:Label ID="Label20" runat="server" Font-Bold="true" Text="Licencias" Font-Size="10" ForeColor="#006699"/></td>
                                       <td style="width:20px"></td>
                                       <td><asp:Label ID="Label22" runat="server" Font-Bold="true" Text="Hectárias" Font-Size="10" ForeColor="#006699"/></td>
                                   </tr>
                                   <tr>
                                       <td><asp:TextBox ID="txtlicencia" Font-Names="Arial" Font-Size="9" runat="server" Width="250px" ForeColor="#006699"></asp:TextBox></td>
                                       <td style="width:20px"></td>
                                       <td><telerik:RadNumericTextBox ID="txtHectaria" runat="server" Width="250px" style="text-align:right;" MinValue="0" 
                                              onkeydown="return (event.keyCode!=13);" MaxLength="10" NumberFormat-DecimalDigits="4" 
                                              NumberFormat-DecimalSeparator="."></telerik:RadNumericTextBox></td>
                                   </tr>
                               </table>
                              <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="Resp4" runat="server" visible="false">
                                  <tr>
                                       <td><asp:Label ID="Label23" runat="server" Font-Bold="true" Text="Nombre del Titular" Font-Size="10" ForeColor="#006699"/></td>
                                       <td style="width:20px"></td>
                                       <td><asp:Label ID="Label24" runat="server" Font-Bold="true" Text="No. Telefono Titular" Font-Size="10" ForeColor="#006699"/></td>
                                   </tr>
                                   <tr>
                                       <td><asp:TextBox ID="txtTitular" Font-Names="Arial" Font-Size="9" runat="server" Width="250px" ForeColor="#006699"></asp:TextBox></td>
                                       <td style="width:20px"></td>
                                       <td><telerik:RadNumericTextBox ID="txtNoTitular" runat="server" Width="250px" style="text-align:right;" MinValue="0" 
                                              onkeydown="return (event.keyCode!=13);" MaxLength="8" NumberFormat-DecimalDigits="0" 
                                              NumberFormat-DecimalSeparator="."></telerik:RadNumericTextBox></td>
                                   </tr>
                                  <tr>
                                                                            
                                      <td><asp:Label ID="Label26" runat="server" Font-Bold="true" Text="Nombre del Elaborador/Regente" Font-Size="10" ForeColor="#006699"/></td>
                                       <td style="width:20px"></td>
                                       <td><asp:Label ID="Label27" runat="server" Font-Bold="true" Text="No. Telefono Elaborador/Regente" Font-Size="10" ForeColor="#006699"/></td>
                                   </tr>
                                   <tr>
                                       <td><asp:TextBox ID="txtElaborador" Font-Names="Arial" Font-Size="9" runat="server" Width="250px" ForeColor="#006699"></asp:TextBox></td>
                                       <td style="width:20px"></td>
                                       <td><telerik:RadNumericTextBox ID="txtNoElaborador" runat="server" Width="250px" style="text-align:right;" MinValue="0" 
                                              onkeydown="return (event.keyCode!=13);" MaxLength="8" NumberFormat-DecimalDigits="0" 
                                              NumberFormat-DecimalSeparator="."></telerik:RadNumericTextBox></td>
                                   </tr>
                                  <tr>
                                       <td><asp:Label ID="Label28" runat="server" Font-Bold="true" Text="Coordenada de la Finca X" Font-Size="10" ForeColor="#006699"/></td>
                                       <td style="width:20px"></td>
                                       <td><asp:Label ID="Label29" runat="server" Font-Bold="true" Text="Coordenada de la Finca Y" Font-Size="10" ForeColor="#006699"/></td>
                                   </tr>
                                   <tr>
                                       <td><telerik:RadNumericTextBox ID="txtCoordenadaX" runat="server" Width="250px" style="text-align:right;" MinValue="0" 
                                              onkeydown="return (event.keyCode!=13);" MaxLength="6" NumberFormat-DecimalDigits="0" 
                                              NumberFormat-DecimalSeparator="."></telerik:RadNumericTextBox></td>
                                       <td style="width:20px"></td>
                                  ...
                                  <tr>
                                       <td><asp:Label ID="Label30" runat="server" Font-Bold="true" Text="Especie" Font-Size="10" ForeColor="#006699"/></td>
                                       <td style="width:20px"></td>
                                       <td><asp:Label ID="Label31" runat="server" Font-Bold="true" Text="Tratamiento" Font-Size="10" ForeColor="#006699"/></td>
                                   </tr>
                                   <tr>
                                       <td><asp:TextBox ID="txtEspecie" Font-Names="Arial" Font-Size="9" runat="server" Width="250px" ForeColor="#006699"></asp:TextBox></td>
                                       <td style="width:20px"></td>
                                       <td><telerik:RadComboBox ID="cboTratamiento" runat="server" EmptyMessage="Seleccione Tratamiento" Width="250px"></telerik:RadComboBox></td>
                                   </tr>
                              </table> 
                              <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="Resp1" runat="server" visible="false">
                                    <tr><td><asp:Label ID="LblTitulo1" runat="server" Font-Bold="true" Text="Tipo de Modificación" Font-Size="10" ForeColor="#006699"/></td></tr>                                       
                                     <tr><td><telerik:RadComboBox ID="CboTipoModificacion" runat="server" EmptyMessage="Seleccione Tipo de Modificacion" Width="600px"></telerik:RadComboBox></td></tr> 
                               </table>                                                             
                              <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="Resp3" runat="server" visible="false">
                                    <tr><td><asp:Label ID="Label15" runat="server" Font-Bold="true" Text="Tipo de Licencia" Font-Size="10" ForeColor="#006699"/></td></tr>                                       
                                     <tr><td><telerik:RadComboBox ID="CboTipoLicencia" runat="server" EmptyMessage="Seleccione Tipo de Licencia" Width="600px"></telerik:RadComboBox></td></tr> 
                               </table>
                              <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="Resp2" runat="server" visible="false">
                                    <tr><td><asp:Label ID="Label19" runat="server" Font-Bold="true" Text="Tipo de Bosque" Font-Size="10" ForeColor="#006699"/></td></tr>                                       
                                     <tr><td><telerik:RadComboBox ID="CboTipoBosque" runat="server" EmptyMessage="Seleccione Tipo de Bosque" Width="600px"></telerik:RadComboBox></td></tr> 
                               </table>                                                                                                                                                                                                                         
                              ...
                              <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;" id="observa" runat="server">
                                  ...
                                  <tr><td><asp:TextBox ID="txtObservaciones" Font-Names="Arial" Font-Size="9"    
                                            runat="server" class="form-control" Width="600px" Height="70px" TextMode="MultiLine" ForeColor="#006699" placeholder="Ingrese especies ..."></asp:TextBox></td></tr>
                              </table> 
                              </div> 
                              </td></tr>
                          </table> 
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">                                                  
                            <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="x1" runat="server" visible="false"> 
                                 <tr>
                                  <td><asp:Label ID="Label36" runat="server" Font-Bold="true" Text="Fecha:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                ...
                                <tr><td><asp:Label ID="lbltitulo" runat="server" Font-Bold="true" Text="" Font-Size="10" Width="200px" ForeColor="#006600"/></td>
                            ...
                            <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="x2" runat="server" visible="false"> 
                                <tr>
                                  <td><asp:Label ID="Label16" runat="server" Font-Bold="true" Text="Tipo de Modificación:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="Lbltipomodifica" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>  
                            </table> 
                            <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="x3" runat="server" visible="false"> 
                                <tr>
                                  <td><asp:Label ID="Label32" runat="server" Font-Bold="true" Text="Tipo de Licencia:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="Lbltipolicencia" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>  
                            </table> 
                            <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="x4" runat="server" visible="false"> 
                                <tr>
                                  <td><asp:Label ID="Label33" runat="server" Font-Bold="true" Text="Tipo de Bosque:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="Lbltipobosque" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>  
                            </table> 
                             <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="x5" runat="server" visible="false"> 
                                <tr>
                                  <td><asp:Label ID="Label25" runat="server" Font-Bold="true" Text="Licencia:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="Lbllicencia" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                                 <tr>
                                  <td><asp:Label ID="Label35" runat="server" Font-Bold="true" Text="Hectarias:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="LblHectaria" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>  
                            </table> 
                            <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="x7" runat="server" visible="false"> 
                                <tr>
                                  <td><asp:Label ID="Label45" runat="server" Font-Bold="true" Text="Area:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="LblArea" runat="server" Font-Bold="true"  Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                                <tr>
                                  <td><asp:Label ID="Label47" runat="server" Font-Bold="true" Text="Volumen:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="LblVolumen" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                            </table> 
                            <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="x6" runat="server" visible="false"> 
                                <tr>
                                  <td><asp:Label ID="Label37" runat="server" Font-Bold="true" Text="Nombre Titular:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="Lbltitular" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                                <tr>
                                  <td><asp:Label ID="Label38" runat="server" Font-Bold="true" Text="Número de Telefono:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="Lblnotitular" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                                <tr>
                                  <td><asp:Label ID="Label39" runat="server" Font-Bold="true" Text="Nombre Elaborador:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="LblElaborador" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                                <tr>
                                  <td><asp:Label ID="Label40" runat="server" Font-Bold="true" Text="Número de Telefono:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="LblnoElaborador" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                                <tr>
                                  <td><asp:Label ID="Label41" runat="server" Font-Bold="true" Text="Especie:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="Lblespecie" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                                <tr>
                                  <td><asp:Label ID="Label42" runat="server" Font-Bold="true" Text="Tratamiento:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="Lbltratamiento" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                                <tr>
                                  <td><asp:Label ID="Label43" runat="server" Font-Bold="true" Text="Coordenada X:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="LblCoordenadax" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                                <tr>
                                  <td><asp:Label ID="Label44" runat="server" Font-Bold="true" Text="Coordenada Y:" Width="200px" Font-Size="10" ForeColor="#006600"/></td>                                                                       
                                  <td><asp:Label ID="LblCoordenadaY" runat="server" Font-Bold="true" Width="200px" Font-Size="10" ForeColor="#000066"/></td>
                                </tr>
                            </table> 
                             <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="Table1" visible="false" runat="server"> 
                                  <tr>
