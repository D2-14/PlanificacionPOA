<%@ Page Title="" Language="C#" MasterPageFile="~/MarcoTrabajo/Site.Master" AutoEventWireup="true" CodeBehind="X_IngresoCapacitacion.aspx.cs" Inherits="PlanificacionPOA.Paginas.X_IngresoCapacitacion" %>
              ...
              <ContentTemplate>
                   ...
                   <telerik:RadGrid runat="server" ID="GrdProductos" AutoGenerateColumns="False" Width="100%" AllowSorting ="false" AllowFilteringByColumn="true" AllowPaging="True" 
                     ...
                     <div id="Informacion" runat="server" visible="false">
                           ...
                           <div class="panel-heading" style="text-align:center;"></div>                             
                              ...
                              <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;">
                                  ...
                                  <tr>
                                      ...
                                      <td style="width:20px"></td>
                                      <td><asp:Label ID="Label25" runat="server" Font-Bold="true" Text="Tipo de Evento" Font-Size="10" ForeColor="#006699"/></td>  
                                  </tr>
                                  <tr>
                                      <td><telerik:RadDatePicker ID="txtFecha" runat="server" Width="250px" onkeydown="return (event.keyCode!=13);"></telerik:RadDatePicker></td>                                     
                                     <td style="width:20px"></td>
                                     <td><telerik:RadComboBox ID="cboEventoP" runat="server" Filter="Contains" EmptyMessage="Seleccione Tipo de Evento" Width="250px" Height="90px"></telerik:RadComboBox></td> 
                                  </tr>                                  
                                  </table>
                              <%--Crejo Se agrego opcion para permitir ingreso de Survey (si o no)--%>
                               <table style="margin:auto;border-collapse:separate;border-spacing:2px;text-align:center; margin-top:20px;" id="IListadoSurvey" runat="server" visible="false" >
                                  ...
                                  <tr>
                                   ...
                                   <table style="margin:auto;border-collapse:separate;border-spacing:2px;text-align:center; margin-top:20px;">
                                     <tr><td><asp:Label ID="Label17" runat="server" Font-Bold="true" Text="Medio de Verificación" Font-Size="10" ForeColor="#006699"/></td></tr>
                                     <tr>
                                   ...
                                   <tr><td style="text-align:center"><asp:Label ID="Lblarchivo" runat="server" Font-Bold="true" Font-Size="10" ForeColor="#ff3300"/></td></tr>
                                   </table> 
                              ...
                              <telerik:RadGrid runat="server" ID="GrdIngresoEncabezado" AutoGenerateColumns="False" Width="100%" AllowSorting ="false" AllowFilteringByColumn="false" AllowPaging="True" 
                                   ...
                                   DataKeyNames="Correlativo,Id_PoAnual,Id_Componente,Id_Subcomponente,Id_ProductoVerificable,Id_UM1,Id_UM2,Id_UM3,Id_Subregion,Id_Mes,
                                                ...
                                                Observaciones,Fecha,Evento,Id_Evento,Survey" NoMasterRecordsText="Sin Información">
                                   <RowIndicatorColumn Visible="False"></RowIndicatorColumn>
                                    <Columns>
                                            <telerik:GridButtonColumn Text="Ingreso de Participantes" CommandName="Select1" HeaderText="Ingreso<br/>Participantes" 
                                          ...
                                          <telerik:GridButtonColumn Text="Ingreso Grupo Etario" CommandName="Select2" HeaderText="Ingreso<br/>Grupo Etario" UniqueName="Botonc" 
                         ...
                         <div id="Participantes" runat="server" visible="false">
                             <table runat="server" id="Table2" style="margin:auto;border-collapse:separate;border-spacing: 2px;"> 
                             <tr>
                                 <td> 
                                  <div class="panel panel-success">
                                  <div class="panel-heading" style="text-align:center;">
                                      <asp:Label ID="Label19" runat="server" Font-Bold="true" Text="Participantes en el Evento" Font-Size="10" ForeColor="#006699"/></div>    
                                        <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;">
                                        <tr>
                                       <td><asp:Label ID="Label11" runat="server" Font-Bold="true" Text="Tipo de Evento" Font-Size="10" ForeColor="#006699"/></td>                                     
                                       <td style="width:20px"></td>
                                       <td><asp:Label ID="Label12" runat="server" Font-Bold="true" Text="Participante" Font-Size="10" ForeColor="#006699"/></td>
                                    </tr>                                  
                                   <tr>
                                     <td><telerik:RadComboBox ID="cboEvento" Skin="MetroTouch" AutoPostBack="true" Enabled ="false" runat="server" Filter="Contains" EmptyMessage="Seleccione Tipo de Evento" Width="250px" Height="90px"></telerik:RadComboBox></td>                                       
                                    <td style="width:20px"></td>
                                     <td><telerik:RadComboBox ID="CboParticipante" Skin="MetroTouch" AutoPostBack="true"   runat="server" Filter="Contains" EmptyMessage="Seleccione Participante" Width="250px" Height="90px"></telerik:RadComboBox></td>   
                                   </tr>
                                  <tr>
                                     <td colspan="3"><asp:Label ID="Lbldato" runat="server" Font-Bold="true" Text="Tipo Participante" Font-Size="10" ForeColor="#006699"/></td>                                                                             
                                  </tr>
                                  <tr>
                                    <td colspan="3"><telerik:RadComboBox ID="CboTipoParticipante" Skin="MetroTouch" AutoPostBack="true" runat="server" Filter="Contains" EmptyMessage="Seleccione tipo participantes" DropDownWidth="600" Width="500px" Height="110px"></telerik:RadComboBox></td>                                                                                                              
                                  </tr>
                                  <tr>                                     
                                    <td><asp:Label ID="Label15" runat="server" Font-Bold="true" Text="Comunidad Lingüistica" Font-Size="10" ForeColor="#006699"/></td>   
                                      <td style="width:20px"></td>
                                    <td colspan="3"><asp:Label ID="Label16" runat="server" Font-Bold="true" Text="Número de Personas" Font-Size="10" ForeColor="#006699"/></td> 
                                  </tr>
                                  <tr>
                                    <td><telerik:RadComboBox ID="CboComunidadL" Skin="MetroTouch" AutoPostBack="true" runat="server" Filter="Contains" EmptyMessage="Seleccione Comunidad" Width="250px" Height="110px"></telerik:RadComboBox></td>                                        
                                     <td style="width:20px"></td>
                                    <td colspan="3"><telerik:RadNumericTextBox ID="txtNumeroPersonasComunidad" runat="server" Width="250px" style="text-align:right;" MinValue="0" ReadOnly="true"
                                 ...
                                 <table style="margin:auto;border-collapse:separate;border-spacing:10px;text-align:center;">
                                     <tr>
                                        <td ><asp:LinkButton ID="BtnGuardarParticipante" runat="server" CssClass="btn btn-primary btn-sm" ToolTip="Guardar Información" Text="Guardar">
                                        <span class="glyphicon glyphicon-floppy-save"></span>&nbsp;Guardar Información</asp:LinkButton></td>                                      
                                ...
                                <telerik:RadGrid runat="server" ID="GrdParticipantes" AutoGenerateColumns="False" Width="100%" AllowSorting ="false" AllowFilteringByColumn="false" AllowPaging="True" 
                                   GridLines="Both" Culture="es-GT" Skin="Office2007" ShowStatusBar ="True" ShowGroupPanel="false" ShowFooter="true">
                                   <GroupingSettings CaseSensitive="False" />
                                      <ClientSettings EnableRowHoverStyle="true" AllowColumnsReorder="True">
                                      <Selecting AllowRowSelect="True"></Selecting>                                          
                         ...
                         <div id="Etario" runat="server" visible="false">
                             ...
                             <tr>
                                 <td> 
                                  <div class="panel panel-success">
                                  <div class="panel-heading" style="text-align:center;">
                                       <asp:Label ID="Label20" runat="server" Font-Bold="true" Text="Pertenencia y Grupo Etario" Font-Size="10" ForeColor="#006699"/>
                                  </div>    
                                     <table style="margin:auto;border-collapse:separate;border-spacing:5px;text-align:center;">
                                        <tr>
                                       <td><asp:Label ID="Label21" runat="server" Font-Bold="true" Text="Género" Font-Size="10" ForeColor="#006699"/></td>                                     
                                       <td style="width:20px"></td>
                                       <td><asp:Label ID="Label22" runat="server" Font-Bold="true" Text="Pueblo de Pertenencia" Font-Size="10" ForeColor="#006699"/></td>
                                        </tr>
                                         <tr>
                                         ...
                                         <tr>
                                            <td><asp:Label ID="Label23" runat="server" Font-Bold="true" Text="Grupo Etario" Font-Size="10" ForeColor="#006699"/></td>                                    
                                            <td style="width:20px"></td>
                                            <td><asp:Label ID="Label24" runat="server" Font-Bold="true" Text="Número de Personas" Font-Size="10" ForeColor="#006699"/></td> 
                                        </tr>
                                          <tr>
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">                                                                                                                                      
                             <table style="margin:auto;border-collapse:separate;border-spacing:10px;" class="table table-bordered border-primary" id="T4s" runat="server">
                                 <tr>
                                       <td><asp:Label ID="Label35" runat="server" Font-Bold="true" Text="Fecha:" Font-Size="10" Width="200px" ForeColor="#006600"/></td>
                                       <td><asp:Label ID="Lblfecha" runat="server" Font-Bold="true" Text="xxx" Font-Size="10" Width="200px" ForeColor="#000066"/></td>
                                 </tr>
                                  <tr>
                                       <td><asp:Label ID="Label14" runat="server" Font-Bold="true" Text="Evento:" Font-Size="10" Width="200px" ForeColor="#006600"/></td>
                                       <td><asp:Label ID="LblEvento" runat="server" Font-Bold="true" Font-Size="10" Width="200px" ForeColor="#000066"/></td>
                                 </tr>
                                <tr>
