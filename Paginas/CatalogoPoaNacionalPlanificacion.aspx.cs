...
{
    public partial class CatalogoPoaNacionalPlanificacion : System.Web.UI.Page
    {
        ...
        protected void fillProducto()
        {
            ...
            Cadena += "AND Id_Region = " + Dt.Id_Region + " AND Id_Subregion = " + Dt.Id_SubRegion + "order by Correlativo;";
            ...
            string CadenaUM = "SELECT IdUnidadMedida Id,Descripcion_UnidadMedida Descripcion FROM Unidad_De_Medida_Nacional WHERE Estado_UnidadMedida = 1";
        ...
        {            
            ...
            DatosTarea Dt = (DatosTarea)Session["info200"];
            CadenaString += "WHERE pn.Id_Region = " + Dt.Id_Region + " AND pn.Id_Subregion = " + Dt.Id_SubRegion;
        ...
        protected Validar_Data Validar_Producto(AIObjetosNacionales d)
        {
            ...
            if (d.CorrelativoPSA == 0) { v.Verificar = true; v.Mensaje += "No ha seleccionado el correaltivo Producto.</br>"; }
            ...
            if (d.Descripcion_Producto != string.Empty)
            {
                ...
                {
                    v.Verificar = true;
                    v.Mensaje += "Ya fue ingresada ese Producto.</br>";
                }
            }
            return v;
        }
        ...
        protected void GuardarProducto_Click(object sender, EventArgs e)
        {
            ...
            if (ai.Opcion == 1)
            {
                ai.Id_Region = Dt.Id_Region;
                ai.Id_Subregion = Dt.Id_SubRegion;
        ...
        protected void GridSubProductoNacional_NeedDataSource(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
        {
            ...
            DatosTarea Dt = (DatosTarea)Session["info200"];
            CadenaString += "WHERE subn.Id_Region = " + Dt.Id_Region + " AND subn.Id_Subregion = " + Dt.Id_SubRegion;
        ...
        protected void fillSubProducto(int IdProducto)
        {
            ...
            Cadena += " AND Id_Region = " + Dt.Id_Region + " AND Id_Subregion = " + Dt.Id_SubRegion;
        ...
        protected void GridActividadNacional_NeedDataSource(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
        {
            ...
            DatosTarea Dt = (DatosTarea)Session["info200"];
            CadenaString += "WHERE an.Id_Region = " + Dt.Id_Region + " AND an.Id_Subregion = " + Dt.Id_SubRegion;
        ...
        {
            PermisosPermitidos = (List<Permisos_del_Sistema>)Session["Permisos_Sistema"];
            string Cadena = "SELECT Id_Actividad Id,Descripcion_Actividad Descripcion FROM Actividad_Nacional WHERE Estado_Actividad = 1 AND Id_Actividad = 1  UNION " +
                            "SELECT Id_Actividad Id,(DescripcionCorrelativo+' '+Descripcion_Actividad) FROM Actividad_Nacional WHERE Estado_Actividad = 1" +
                            " AND Id_producto = " + IdProducto.ToString() + " AND Id_Subproducto = " + IdSubproducto.ToString();

            DatosTarea Dt = (DatosTarea)Session["info200"];
            
            Cadena += " AND Id_Region = " + Dt.Id_Region + " AND Id_Subregion = " + Dt.Id_SubRegion;
            Cadena += " ORDER BY Id_Actividad";
        ...
        protected void GuardarConfiguracionUM_Click(object sender, EventArgs e)
        {
            ...
            {
                Configurar.Id_Region = Dt.Id_Region;
                Configurar.Id_Subregion = Dt.Id_SubRegion;
            }
            else
            {
            ...
            else
            {
                ...
                if (Mmp.Guardar_producto_ConfiguracionPlani(Configurar,Dt.Id_PoAnual ,DescripcionProductoConfiguracion, ref er))
                {
                    if (Configurar.Opcion == 1)
                    {
        ...
        {           
            ...
            if (Mmp.Eliminacion_ProductoNacionalPlani(Id, Id_usu,Dt.Id_PoAnual ,Convert.ToInt32(item.GetDataKeyValue("Id_Region").ToString()),
            ...
            {
                GrdConfiguracionUM.Visible = Visible;
            }
        }
        ...
        {
            DatosTarea Dt = (DatosTarea)Session["info200"];
            procesos.LlenarRadGrid(GrdConfiguracionUM, "EXEC Sp_obtener_data_ProductosNacionalespLANI " + Dt.Id_Region + ","+Dt.Id_PoAnual +","+ Dt.Id_SubRegion + ";");
        }
