...
{
    public partial class X_Pinabete : System.Web.UI.Page
    {
        ...
        protected void Seleccionar_Productos(object sender, GridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Select")
            {
                ...
                {
                    T1x1.Visible = true;
                    procesos.LLenarComboT(CboTipoArea, "SELECT Id_TipoArea Id,Descripcion FROM Tipo_Area WHERE Estado = 1;", "Descripcion", "Id", true);
        ...
        protected void CancelarIngreso_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                txtNoRegistro.Text = string.Empty;
                CboTipoArea.ClearSelection(); 
            }
        }
        ...
        {
            DatosMonitoreoIngresoMetas DMI = (DatosMonitoreoIngresoMetas)Session["DatosMonitoreoIngresoMetasENVIO"];
            string CadenaSql = "Sp_obtener_data_GridProductosMonitoreo " + 9 + "," + DMI.Id_PoAnual + "," + DMI.Id_Subregion + "," + DMI.IdComponente
        ...
        protected void GrdIngresoEncabezado_ItemDataBound(object sender, GridItemEventArgs e)
        {
            ...
            if (e.Item is GridDataItem)
            {
                ...
                GrdIngresoEncabezado.MasterTableView.GetColumn("BotonD").Display = VPC.ShowHideProductoPinabete(Producto, 1);
                GrdIngresoEncabezado.MasterTableView.GetColumn("BotonC").Display = VPC.ShowHideProductoPinabete(Producto, 1);
                /*validar Valores 0*/
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            ...
            EncabezadoPinabete Generico = new EncabezadoPinabete();
            ManejoInformacionMonitoreo Mim = new ManejoInformacionMonitoreo();            
            Mensajes_Error_BDD er = new Mensajes_Error_BDD();
            Medios DA;
            Validar_Data v;
            ...
            Generico.Id_TipoArea = procesos.IntNULLCombo(CboTipoArea);
            Generico.NoRegistro = txtNoRegistro.Text.ToString();
            ...
            v = Validar.Campos_Obligatorio_Pinabete(Generico, RadDocumentoVerificacion, DMI,Mantenimiento);
            if (v.Verificar)
            {
                MensajePantalla(v.Mensaje);               
            }
            else
            {
                ...
                XmlDocument DescripcionProducto = Mim.DetalleXMLProductoEncabezadoPinabete(Generico);

                if (Mim.GuardarItemEncabezado(8, DMI, DescripcionProducto, ref er))
                {
        ...
        protected void Eliminar_Items(object source, GridCommandEventArgs e)
        {
            ...
            {
                if (Mim.Eliminacion_Producto(10, edm, ref er))
                {
                    RecargarGrid();
                }
                else
        ...
        protected void Seleccionar_Items(object sender, GridCommandEventArgs e)
        {
            ...
            if (Llave == 0)
            {
                ...
                {
                    x1t1.Visible = true;
                    Ltipoarea.Text = item.GetDataKeyValue("TipoArea").ToString();
                    LRegistro.Text = item.GetDataKeyValue("NoRegistro").ToString();
                    LExpediente.Text = item.GetDataKeyValue("NoExpediente").ToString();
                    Largo = "390";
                }
